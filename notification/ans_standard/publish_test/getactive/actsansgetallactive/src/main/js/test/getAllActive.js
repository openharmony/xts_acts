...
var time = 500
export default function ActsAnsAllActiveTestOne() {
describe('ActsAnsAllActiveTestOne', function () {
    ...
    /*
    * @tc.number: Ans_GetAllActive_0100
    ...
    */
    it('Ans_GetAllActive_0100', 0, async function (done) {
    ...
    */
    ...
    /*
    * @tc.number: Ans_GetAllActive_0300
    * @tc.name: getAllActiveNotifications(callback: AsyncCallback<Array<NotificationRequest>>): void;
    ...
    */
    it('Ans_GetAllActive_0300', 0, async function (done) {
    ...
    /*
    * @tc.number: Ans_GetAllActive_0400
    * @tc.name: getAllActiveNotifications(): Promise<Array<NotificationRequest>>;
    ...
    */
    it('Ans_GetAllActive_0400', 0, async function (done) {
    ...
    /*
    * @tc.number: Ans_GetAllActive_0500
    * @tc.name: getAllActiveNotifications(callback: AsyncCallback<Array<NotificationRequest>>): void;
    ...
    */
    it('Ans_GetAllActive_0500', 0, async function (done) {
    ...
    /*
    * @tc.number: Ans_GetAllActive_0600
    * @tc.name: getAllActiveNotifications(): Promise<Array<NotificationRequest>>;
    * @tc.desc: Verify: After the current app and other apps publish two notifications, remove all the notifications
                of the system, get all active notifications in the system(promise)
    */
    it('Ans_GetAllActive_0600', 0, async function (done) {

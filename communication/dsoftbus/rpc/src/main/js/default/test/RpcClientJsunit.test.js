...
describe('ActsRpcClientJsTest', function(){
    ...
    it("SUB_Softbus_IPC_MessageParcel_5900", 0,async function(done){
        ...
        try{
            ...
            gIRemoteObject.sendRequest(CODE_WRITE_CHAR, data, reply, option).then((result) => {
    ...
    it("SUB_Softbus_IPC_MessageParcel_8900", 0,async function(done){
        ...
        try{
            ...
            gIRemoteObject.sendRequest(CODE_ALL_TYPE, data, reply, option).then((result) => {
    ...
    try{
        ...
        gIRemoteObject.sendRequest(CODE_WRITE_REMOTEOBJECT, data, reply, option)
            .then((result)=> {
                console.info("sendRequest done, error code: " + result.errCode)
                expect(result.errCode).assertEqual(0)
                result.reply.readException()

...
// To detect unsigned integer overflows in addition, subtraction, multiplication, and division.
static napi_value UnsignedIntegerOverflow(napi_env env, napi_callback_info info)
{
    struct sigaction sigabrt = {
        .sa_handler = SignalHandlerAbort,
    };
...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        {"unsignedIntegerOverflow", nullptr, UnsignedIntegerOverflow, nullptr, nullptr, nullptr, napi_default, nullptr},
    };
...
static napi_module demoModule = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = "integerOverflow",
    .nm_register_func = Init,
    .nm_modname = "integerOverflow",
    .nm_priv = ((void *)0),
    .reserved = {0},
};

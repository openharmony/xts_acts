...
[[maybe_unused]] JSVM_Value TestGetValueInt32Case01(JSVM_Env env, JSVM_CallbackInfo info)
{
    ...
    status = OH_JSVM_CreateStringUtf8(env,"teststr",7,&description);
    if(status != JSVM_OK){
...
[[maybe_unused]] JSVM_Value TestGetValueInt64Case01(JSVM_Env env, JSVM_CallbackInfo info)
{
    ...
    JSVM_Value description;
    status = OH_JSVM_CreateStringUtf8(env, "test", 4, &description);
    if(status != JSVM_OK){
...
[[maybe_unused]] JSVM_Value TestBasicDataTypesCase01(JSVM_Env env, JSVM_CallbackInfo info)
{
    ...
    uint32_t dataValue;
    status = OH_JSVM_GetValueUint32(env, numVal, &dataValue);
    if(status != JSVM_OK){
        OH_JSVM_ThrowError(env, nullptr, "TestBasicDataTypesCase01:OH_JSVM_GetValueUint32 Failed.");
        return nullptr;
    }
    if(dataValue != 4294967295){
...
[[maybe_unused]] JSVM_Value TestBasicDataTypesCase02(JSVM_Env env, JSVM_CallbackInfo info)
{
    ...
    if(status != JSVM_OK){
        OH_JSVM_ThrowError(env, nullptr, "TestBasicDataTypesCase02:OH_JSVM_CreateUint32 Failed.");
        return nullptr;
    }
    ...
    if(status != JSVM_OK){
        OH_JSVM_ThrowError(env, nullptr, "TestBasicDataTypesCase02:OH_JSVM_GetValueUint32 Failed.");
        return nullptr;
    }
    if(retValue != 1){
...
[[maybe_unused]] JSVM_Value TestBasicDataTypesCase04(JSVM_Env env, JSVM_CallbackInfo info)
{
    ...
    status = OH_JSVM_GetValueInt32(env, desNum, &retValue1);
    if(status != JSVM_OK){
        OH_JSVM_ThrowError(env, nullptr, "TestBasicDataTypesCase04:OH_JSVM_GetValueInt32 Failed.");
        return nullptr;
    }
    if(retValue1 != 1){

...
//construct parameters and call the test interface twice in a row,first ok,second not ok
// [[maybe_unused]] JSVM_Value TestRejectDeferredCase03(JSVM_Env env, JSVM_CallbackInfo info)
// {
//    bool setVal = false;
//     JSVM_Value retVal = nullptr;
//     OH_JSVM_GetBoolean(env, setVal, &retVal);

...
void prototypeof_test_6(JSVM_Env env)
{
    JSVM_HandleScope handleScope;
    OH_JSVM_OpenHandleScope(env, &handleScope);
...
static JSVM_CallbackStruct param[] = {
    ...
    {.data = nullptr, .callback = GetEnumerableNames},
    {.data = nullptr, .callback = GetOwnWritableNames},
    {.data = nullptr, .callback = GetEnumerableConfigurableNames},
    {.data = nullptr, .callback = GetOwnConfigurableNames},
    {.data = nullptr, .callback = SetProperty},
    {.data = nullptr, .callback = SetPropertyFailed},
    {.data = nullptr, .callback = GetProperty},
    {.data = nullptr, .callback = GetPropertyFailed},
    {.data = nullptr, .callback = HasProperty},
    {.data = nullptr, .callback = HasPropertyFailed},
    {.data = nullptr, .callback = DeleteProperty},
    {.data = nullptr, .callback = DeletePropertyFailed},
    {.data = nullptr, .callback = HasOwnProperty},
    {.data = nullptr, .callback = HasOwnPropertyFailed},
    {.data = nullptr, .callback = SetNamedPropertyCreateObject},
    {.data = nullptr, .callback = SetNamedProperty},
    {.data = nullptr, .callback = SetNamedPropertyFailed},
    {.data = nullptr, .callback = GetNamedProperty},
    {.data = nullptr, .callback = GetNamedPropertyFailed},
    {.data = nullptr, .callback = HasNamedProperty},
    {.data = nullptr, .callback = HasNamedPropertyFailed},
    {.data = nullptr, .callback = SetElementWithLength},
    {.data = nullptr, .callback = SetElement},
    {.data = nullptr, .callback = SetElementFailed},
    {.data = nullptr, .callback = GetElement},
    {.data = nullptr, .callback = GetElementFailed},
    {.data = nullptr, .callback = HasElement},
    {.data = nullptr, .callback = HasElementFailed},
    {.data = nullptr, .callback = DeleteElement},
    {.data = nullptr, .callback = DeleteElementAndCheck},
    {.data = nullptr, .callback = DeleteElementFailed},
    {.data = nullptr, .callback = DefineMethodProperties},
    {.data = nullptr, .callback = DefineStringProperties},
    {.data = nullptr, .callback = DefineGetterProperties},
    {.data = nullptr, .callback = DefinePropertiesFailed},
    {.data = nullptr, .callback = ObjectFreeze},
    {.data = nullptr, .callback = ObjectSeal},
    {.data = nullptr, .callback = GetVersion},
    {.data = nullptr, .callback = GetVersionFailed},
    {.data = nullptr, .callback = GetVMInfo},
    {.data = nullptr, .callback = JsonStringify},
    {.data = nullptr, .callback = JsonStringifyFailed},
    {.data = nullptr, .callback = JsonParseNumber},
    {.data = nullptr, .callback = JsonParseObject},
    {.data = nullptr, .callback = JsonParse},
    {.data = nullptr, .callback = JsonParseFailed},
    {.data = nullptr, .callback = CallFunction},
    {.data = nullptr, .callback = CallFunctionWithArg},
    {.data = nullptr, .callback = CallFunctionWithObject},
    {.data = nullptr, .callback = CallFunctionFailed},
    {.data = nullptr, .callback = CreateFunction},
    {.data = nullptr, .callback = CreateFunctionFailed},
    ...
    {.data = nullptr, .callback = JsVmThrow},
    {.data = nullptr, .callback = JsVmThrowFromJS},
    ...
    {.data = nullptr, .callback = JsVmCreateError},
    ...
    {.data = nullptr, .callback = CreateSnapshotFailed},
    {.data = nullptr, .callback = DebugCodeUsingCpuProfiler},
    {.data = nullptr, .callback = TakeHeapSnapshot},
    {.data = nullptr, .callback = DebugCodeUsingInspector},

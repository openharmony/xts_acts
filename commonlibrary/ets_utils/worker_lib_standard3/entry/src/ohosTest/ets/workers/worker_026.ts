...
workerPort.onmessage = (e: MessageEvents) => {
  ...
  if (e.data === 'GlobalScope') {
    const flag: boolean = workerPort.self.name === 'workerInstance' && workerPort.name === 'workerInstance';
    workerPort.postMessage(flag);
  } else if (e.data === 'ErrorEvent') {

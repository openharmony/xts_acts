...
describe("VectorTest", function () {
   ...
   */
  it("testInsert006", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testInsert008", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testInsert009", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testLength010", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testGet013", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testGetIndexOf015", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add(1);
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testGetFirstElement016", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   * @tc.desc: Get the header element of the Vector instance. For example: vector.getFirstElement().
   */
  it("testGetFirstElement017", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    let res = vector.getFirstElement();
   ...
   */
  it("testRemove020", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testGetLastElement022", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   * @tc.desc: Get the end element of the Vector instance. For example: vector.getLastElement().
   */
  it("testGetLastElement023", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    let res = vector.getLastElement();
    expect(res).assertEqual(undefined);
  });
   ...
   */
  it("testGetLastIndexOf024", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testGetLastIndexFrom025", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   * return -1.vector.getLastIndexFrom(1, 5).
   */
  it("testGetIndexFrom026", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testRemoveByRange027", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);
   ...
   */
  it("testRemoveByRange028", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let vector = new Vector();
    vector.add("四");
    vector.add("三");
    vector.add(1);

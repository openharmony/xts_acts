...
workerPort.onmessage = function(e) {
  ...
  let childworker = new worker.ThreadWorker('entry_test/ets/workers/childworker.ets');
  ...
  childworker.onexit = () => {
    ...
    workerPort.postMessage('parentworker send message to main thread');
  };

  childworker.onerror = function(e) {

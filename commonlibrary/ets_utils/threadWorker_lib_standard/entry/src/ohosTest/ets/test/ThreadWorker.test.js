...
describe('threadWorkerTest', function () {
    ...
    it('restrictedWorker_test_001', 0, async function (done) {
        let ss = new worker.RestrictedWorker("entry_test/ets/workers/newworker_002.js");
        let res = 0;
        let isTerminate = false;
    ...
    it('restrictedWorker_test_002', 0, async function (done) {
        let ss = new worker.RestrictedWorker("entry_test/ets/workers/restrictedWorker_001.js");
        let res = "";
        let isTerminate = false;

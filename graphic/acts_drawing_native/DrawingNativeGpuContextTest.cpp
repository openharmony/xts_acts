 ...
 * @tc.level : Level 1
 */
HWTEST_F(DrawingNativeGpuContextTest, OH_Drawing_GpuContextCreateFromGL, TestSize.Level1) {
 ...
 * @tc.level : Level 1
 */
HWTEST_F(DrawingNativeGpuContextTest, OH_Drawing_GpuContextDestroy, TestSize.Level1) {
    // todo cpp crash when OH_Drawing_GpuContextCreateFromGL
}

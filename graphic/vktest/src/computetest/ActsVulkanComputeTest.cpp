...
namespace OHOS {
    ...
    HWTEST_F(ActsVulkanComputeTest, TestVulkanComputeTestCase, Function | MediumTest | Level2)
    {
        ...
        system("/data/local/tmp/vulkan/vk-default/deqp_vk_execute --deqp-caselist-file=/data/local/tmp/vktest/vk-default/compute.txt --deqp-log-filename=ActsVulkanComputeTest.qpa");
        EXPECT_TRUE(true);

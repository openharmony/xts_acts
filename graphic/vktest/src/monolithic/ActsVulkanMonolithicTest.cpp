...
namespace OHOS {
    ...
    void ActsVulkanMonolithicTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanMonolithicTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanMonolithicTest::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanMonolithicTest::TearDown()
    {
    }

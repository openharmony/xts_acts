...
namespace OHOS {
    ...
    HWTEST_F(ActsVulkanImageless_framebufferTest, TestVulkanImageless_framebufferTestCase, Function | MediumTest | Level2)
    {
        ...
        system("/data/local/tmp/vulkan/vk-default/deqp_vk_execute --deqp-caselist-file=/data/local/tmp/vktest/vk-default/imageless-framebuffer.txt --deqp-log-filename=ActsVulkanImageless_framebufferTest.qpa");
        EXPECT_TRUE(true);

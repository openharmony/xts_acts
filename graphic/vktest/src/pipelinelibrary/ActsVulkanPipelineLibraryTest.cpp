...
namespace OHOS {
    ...
    void ActsVulkanPipelineLibraryTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanPipelineLibraryTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanPipelineLibraryTest::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanPipelineLibraryTest::TearDown()
    {
    }

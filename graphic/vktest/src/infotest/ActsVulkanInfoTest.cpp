...
namespace OHOS {
    ...
    HWTEST_F(ActsVulkanInfoTest, TestVulkanInfoTestCase, Function | MediumTest | Level2)
    {
        ...
        system("/data/local/tmp/vulkan/vk-default/deqp_vk_execute --deqp-caselist-file=/data/local/tmp/vktest/vk-default/info.txt --deqp-log-filename=ActsVulkanInfoTest.qpa");
        EXPECT_TRUE(true);

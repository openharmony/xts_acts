...
#include "ActsOpenGl461xGl30GtfMasterTest.h"
...
namespace OHOS {
    ...
    void ActsOpenGl461xGl30GtfMasterTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsOpenGl461xGl30GtfMasterTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsOpenGl461xGl30GtfMasterTest::SetUp()
    {
    }
    ...
    /*
     * @tc.number: ActsOpenGl461xGl30GtfMasterTest

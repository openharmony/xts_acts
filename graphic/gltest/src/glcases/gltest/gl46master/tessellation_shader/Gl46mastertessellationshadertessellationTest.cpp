...
static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008304,
    "KHR-GL46.tessellation_shader.tessellation_shader_tessellation.gl_InvocationID_PatchVerticesIn_PrimitiveID");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008305,
    "KHR-GL46.tessellation_shader.tessellation_shader_tessellation.TCS_TES");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008306,
    "KHR-GL46.tessellation_shader.tessellation_shader_tessellation.TES");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008307,
    "KHR-GL46.tessellation_shader.tessellation_shader_tessellation.input_patch_discard");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008308,

...
static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008290,
    "KHR-GL46.tessellation_shader.single.default_values_of_context_wide_properties");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008291,
    "KHR-GL46.tessellation_shader.single.isolines_tessellation");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008292,
    "KHR-GL46.tessellation_shader.single.ext_program_interface_query_dependency");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008293,
    "KHR-GL46.tessellation_shader.single.program_object_properties");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008294,
    "KHR-GL46.tessellation_shader.single.xfb_captures_data_from_correct_stage");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008295,
    "KHR-GL46.tessellation_shader.single.max_patch_vertices");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_008296,

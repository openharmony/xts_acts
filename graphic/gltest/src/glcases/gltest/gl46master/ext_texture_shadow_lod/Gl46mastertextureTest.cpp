...
static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_000843,
    "KHR-GL46.ext_texture_shadow_lod.texture.sampler2darrayshadow_fragment");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_000844,
    "KHR-GL46.ext_texture_shadow_lod.texture.sampler2darrayshadow_bias_fragment");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_000845,
    "KHR-GL46.ext_texture_shadow_lod.texture.samplercubearrayshadow_vertex");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_000846,
    "KHR-GL46.ext_texture_shadow_lod.texture.samplercubearrayshadow_fragment");

static SHRINK_HWTEST_SF(ActsGl46master0001TestSuite, TestCase_000847,

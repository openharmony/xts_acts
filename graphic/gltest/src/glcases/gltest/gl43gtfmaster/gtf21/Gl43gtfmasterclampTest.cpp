...
static SHRINK_HWTEST_SF(ActsGl43gtfmaster0001TestSuite, TestCase_000255,
    "GTF-GL43.gtf21.GL.clamp.clamp_float_frag_xvary_yconstquarter");

static SHRINK_HWTEST_SF(ActsGl43gtfmaster0001TestSuite, TestCase_000256,
    "GTF-GL43.gtf21.GL.clamp.clamp_vec2_frag_xvary_yconstquarter");

static SHRINK_HWTEST_SF(ActsGl43gtfmaster0001TestSuite, TestCase_000257,
    "GTF-GL43.gtf21.GL.clamp.clamp_vec3_frag_xvary_yconstquarter");

static SHRINK_HWTEST_SF(ActsGl43gtfmaster0001TestSuite, TestCase_000258,
    "GTF-GL43.gtf21.GL.clamp.clamp_float_vert_xvary_yconstquarter");

static SHRINK_HWTEST_SF(ActsGl43gtfmaster0001TestSuite, TestCase_000259,
    "GTF-GL43.gtf21.GL.clamp.clamp_vec2_vert_xvary_yconstquarter");

static SHRINK_HWTEST_SF(ActsGl43gtfmaster0001TestSuite, TestCase_000260,

...
static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003555,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.api_coverage_invalid_glbeginquery_calls");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003556,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.api_coverage_unsupported_calls");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003557,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.functional_default_qo_values");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003558,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.functional_non_rendering_commands_do_not_affect_queries");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003559,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.functional_primi"
    "tives_vertices_submitted_and_clipping_input_output_primitives");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003560,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.functional_vertex_shader_invocations");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003561,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.functional_tess_queries");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003562,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.functional_geometry_shader_queries");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003563,
    "KHR-GL40.pipeline_statistics_query_tests_ARB.functional_fragment_shader_invocations");

static SHRINK_HWTEST_SF(ActsGl40master0001TestSuite, TestCase_003564,

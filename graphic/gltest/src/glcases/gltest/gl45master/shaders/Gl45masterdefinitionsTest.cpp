...
static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002169,
    "KHR-GL45.shaders.preprocessor.definitions.define_value_and_function_vertex");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002170,
    "KHR-GL45.shaders.preprocessor.definitions.define_value_and_function_fragment");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002171,
    "KHR-GL45.shaders.preprocessor.definitions.undefine_object_invalid_syntax_vertex");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002172,
    "KHR-GL45.shaders.preprocessor.definitions.undefine_object_invalid_syntax_fragment");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002173,
    "KHR-GL45.shaders.preprocessor.definitions.undefine_function_vertex");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002174,
    "KHR-GL45.shaders.preprocessor.definitions.undefine_function_fragment");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002175,
    "KHR-GL45.shaders.preprocessor.definitions.undefine_version_vertex");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002176,
    "KHR-GL45.shaders.preprocessor.definitions.undefine_version_fragment");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002177,
    "KHR-GL45.shaders.preprocessor.definitions.undefine_core_profile_vertex");

static SHRINK_HWTEST_SF(ActsGl45master0001TestSuite, TestCase_002178,

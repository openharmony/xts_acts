...
static SHRINK_HWTEST_SF(ActsGl46gtfmaster0001TestSuite, TestCase_000743,
    "GTF-GL46.gtf21.GL.smoothstep.smoothstep_float_frag_xvary_edgeconstquarter");

static SHRINK_HWTEST_SF(ActsGl46gtfmaster0001TestSuite, TestCase_000744,
    "GTF-GL46.gtf21.GL.smoothstep.smoothstep_vec2_frag_xvary_edgeconstquarter");

static SHRINK_HWTEST_SF(ActsGl46gtfmaster0001TestSuite, TestCase_000745,
    "GTF-GL46.gtf21.GL.smoothstep.smoothstep_vec3_frag_xvary_edgeconstquarter");

static SHRINK_HWTEST_SF(ActsGl46gtfmaster0001TestSuite, TestCase_000746,
    "GTF-GL46.gtf21.GL.smoothstep.smoothstep_float_vert_xvary_edgeconstquarter");

static SHRINK_HWTEST_SF(ActsGl46gtfmaster0001TestSuite, TestCase_000747,
    "GTF-GL46.gtf21.GL.smoothstep.smoothstep_vec2_vert_xvary_edgeconstquarter");

static SHRINK_HWTEST_SF(ActsGl46gtfmaster0001TestSuite, TestCase_000748,

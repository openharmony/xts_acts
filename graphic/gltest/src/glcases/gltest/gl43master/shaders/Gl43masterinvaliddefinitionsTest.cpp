...
static SHRINK_HWTEST_SF(ActsGl43master0001TestSuite, TestCase_002179,
    "KHR-GL43.shaders.preprocessor.invalid_definitions.define_non_identifier_vertex");

static SHRINK_HWTEST_SF(ActsGl43master0001TestSuite, TestCase_002180,
    "KHR-GL43.shaders.preprocessor.invalid_definitions.define_non_identifier_fragment");

static SHRINK_HWTEST_SF(ActsGl43master0001TestSuite, TestCase_002181,
    "KHR-GL43.shaders.preprocessor.invalid_definitions.undef_non_identifier_1_vertex");

static SHRINK_HWTEST_SF(ActsGl43master0001TestSuite, TestCase_002182,
    "KHR-GL43.shaders.preprocessor.invalid_definitions.undef_non_identifier_1_fragment");

static SHRINK_HWTEST_SF(ActsGl43master0001TestSuite, TestCase_002183,
    "KHR-GL43.shaders.preprocessor.invalid_definitions.undef_non_identifier_2_vertex");

static SHRINK_HWTEST_SF(ActsGl43master0001TestSuite, TestCase_002184,

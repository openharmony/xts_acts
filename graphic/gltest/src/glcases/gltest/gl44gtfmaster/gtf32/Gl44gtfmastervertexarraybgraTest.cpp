...
static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001536,
    "GTF-GL44.gtf32.GL3Tests.vertex_array_bgra.vertex_array_bgra_basic");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001537,
    "GTF-GL44.gtf32.GL3Tests.vertex_array_bgra.vertex_array_bgra_draw_calls");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001538,
    "GTF-GL44.gtf32.GL3Tests.vertex_array_bgra.vertex_array_bgra_primitive_types");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001539,
    "GTF-GL44.gtf32.GL3Tests.vertex_array_bgra.vertex_array_bgra_stride");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001540,
    "GTF-GL44.gtf32.GL3Tests.vertex_array_bgra.vertex_array_bgra_pointer");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001541,
    "GTF-GL44.gtf32.GL3Tests.vertex_array_bgra.vertex_array_bgra_attrib_sizes");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001542,
    "GTF-GL44.gtf32.GL3Tests.vertex_array_bgra.vertex_array_bgra_primitive_restart");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001543,

...
static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001065,
    "GTF-GL44.gtf21.GL2Tests.compile_shader.successful_compile_vert");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001066,
    "GTF-GL44.gtf21.GL2Tests.compile_shader.successful_compile_frag");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001067,
    "GTF-GL44.gtf21.GL2Tests.compile_shader.unsuccessful_compile_vert");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001068,
    "GTF-GL44.gtf21.GL2Tests.compile_shader.unsuccessful_compile_frag");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001069,
    "GTF-GL44.gtf21.GL2Tests.compile_shader.compile_emptyhandle_vert");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001070,
    "GTF-GL44.gtf21.GL2Tests.compile_shader.compile_emptyhandle_frag");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001071,
    "GTF-GL44.gtf21.GL2Tests.compile_shader.compile_invalid_handle");

static SHRINK_HWTEST_SF(ActsGl44gtfmaster0001TestSuite, TestCase_001072,

...
namespace OHOS {
    ...
    HWTEST_F(ActsOpenGLglesammasterTest, TestOpenGLglTestCase01, Function | MediumTest | Level2)
    {
        ...
        if (canIUse("SystemCapability.Graphic.OpenGL")) {
            system("/data/local/tmp/opengl/mustpass/glcts "
                "--deqp-caselist-file=/data/local/tmp/opengl/mustpass/gles/aosp_mustpass/master/src/"
    ...
    HWTEST_F(ActsOpenGLglesammasterTest, TestOpenGLglTestCase24, Function | MediumTest | Level2)
    {
        ...
        if (canIUse("SystemCapability.Graphic.OpenGL")) {
            system("/data/local/tmp/opengl/mustpass/glcts "
                "--deqp-caselist-file=/data/local/tmp/opengl/mustpass/gles/aosp_mustpass/master/"
                "gles2-master.txt "

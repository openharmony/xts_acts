...
static SHRINK_HWTEST_F(ActsEgl0001TS, TC003328, "dEQP-EGL.functional.reusable_sync.valid.create_null_attribs");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003329, "dEQP-EGL.functional.reusable_s"
    "ync.valid.create_empty_attribs");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003330, "dEQP-EGL.functional.reusable_sync.valid.wait_no_timeout");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003331, "dEQP-EGL.functional.reusable_sync.valid.wait_forever");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003332, "dEQP-EGL.functional.reusable_sync.valid.wait_no_context");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003333, "dEQP-EGL.functional.reusable_sync.valid.wait_forever_flush");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003334, "dEQP-EGL.functional.reusable_sync.valid.get_type");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003335, "dEQP-EGL.functional.reusable_sync.valid.get_status");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003336, "dEQP-EGL.functional.reusable_sync.valid.get_status_signaled");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003337, "dEQP-EGL.functional.reusable_sync.valid.destroy");
...
static SHRINK_HWTEST_F(ActsEgl0001TS, TC003342, "dEQP-EGL.functional.reusable_sync.invalid.wait_invalid_sync");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003343, "dEQP-EGL.functional.reusable_s"
    "ync.invalid.get_invalid_display");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003344, "dEQP-EGL.functional.reusable_sync.invalid.get_invalid_sync");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003345, "dEQP-EGL.functional.reusable_sy"
    "nc.invalid.get_invalid_attribute");

static SHRINK_HWTEST_F(ActsEgl0001TS, TC003346, "dEQP-EGL.functional.reusable_sync.invalid.get_invalid_value");

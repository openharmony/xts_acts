...
static SHRINK_HWTEST_F(ActsEgl0001TS, TC000453, "dEQP-EGL.functional.choose_config.random.color_sizes");
...
static SHRINK_HWTEST_F(ActsEgl0001TS, TC000458, "dEQP-EGL.functional.choose_config.random.all");

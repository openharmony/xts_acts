...
static HWTEST_F(ActsKhrglesext0001TestSuite, TestCase_000212, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsKhrglesext0001TestSuite, TestCase_000213, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsKhrglesext0001TestSuite, TestCase_000214, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ".",
        "--deqp-case="
        "KHR-GLESEXT.tessellation"
        "_shader.winding.quads_ccw",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrglesext0001TestSuite, TestCase_000215, Function | MediumTest | Level2)
{

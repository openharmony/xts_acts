...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000667, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "rpolation.render.base.rgba8ui.samples_1",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000668, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_inte"
        "rpolation.render.base.rgba8ui.samples_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000669, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_inte"
        "rpolation.render.base.rgba8ui.samples_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };

...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000715, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "ender.interpolate_at_sample_check.rgba8ui.samples_1",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000716, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation.r"
        "ender.interpolate_at_sample_check.rgba8ui.samples_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000717, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation.r"
        "ender.interpolate_at_sample_check.rgba8ui.samples_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };

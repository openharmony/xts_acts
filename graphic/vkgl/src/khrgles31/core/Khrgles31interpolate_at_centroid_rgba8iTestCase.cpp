...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000724, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        ".render.interpolate_at_centroid.rgba8i.samples_1",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000725, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation"
        ".render.interpolate_at_centroid.rgba8i.samples_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000726, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation"
        ".render.interpolate_at_centroid.rgba8i.samples_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };

...
static SHRINK_HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000733,
        "KHR-GLES31.core.shader_multisample_interpolation.r",
        "ender.interpolate_at_centroid_check.rgba8.samples_1");

static SHRINK_HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000734,
        "KHR-GLES31.core.shader_multisample_interpolation.r",
        "ender.interpolate_at_centroid_check.rgba8.samples_2");

static SHRINK_HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000735,
        "KHR-GLES31.core.shader_multisample_interpolation.r",

...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000718, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "ender.interpolate_at_sample_check.rgba32f.samples_1",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000719, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation.r"
        "ender.interpolate_at_sample_check.rgba32f.samples_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000720, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation.r"
        "ender.interpolate_at_sample_check.rgba32f.samples_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };

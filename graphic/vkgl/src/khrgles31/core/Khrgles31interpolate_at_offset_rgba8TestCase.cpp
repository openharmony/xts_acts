...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000745, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "on.render.interpolate_at_offset.rgba8.samples_1",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000746, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolati"
        "on.render.interpolate_at_offset.rgba8.samples_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000747, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolati"
        "on.render.interpolate_at_offset.rgba8.samples_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };

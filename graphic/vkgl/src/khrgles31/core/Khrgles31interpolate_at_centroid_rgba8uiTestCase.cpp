...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000727, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        ".render.interpolate_at_centroid.rgba8ui.samples_1",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000728, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation"
        ".render.interpolate_at_centroid.rgba8ui.samples_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000729, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_interpolation"
        ".render.interpolate_at_centroid.rgba8ui.samples_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };

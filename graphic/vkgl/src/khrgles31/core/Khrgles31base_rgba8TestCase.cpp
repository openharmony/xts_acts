...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000661, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ".",
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_int"
        "erpolation.render.base.rgba8.samples_1",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000662, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_int"
        "erpolation.render.base.rgba8.samples_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000663, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.shader_multisample_int"
        "erpolation.render.base.rgba8.samples_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };

...
static SHRINK_HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018491,
        "dEQP-GLES3.functional.shaders.builtin_functi",
        "ons.precision.degrees.mediump_fragment.scalar");

static SHRINK_HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018492,
        "dEQP-GLES3.functional.shaders.builtin_funct",
        "ions.precision.degrees.mediump_fragment.vec2");

static SHRINK_HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018493,
        "dEQP-GLES3.functional.shaders.builtin_funct",
        "ions.precision.degrees.mediump_fragment.vec3");

static SHRINK_HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018494,
        "dEQP-GLES3.functional.shaders.builtin_funct",

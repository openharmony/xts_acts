...
export const testNativeWindowCleanCacheLoopProduceBuffer_1: () => number;
export const testNativeWindowCleanCacheLoopProduceBuffer_2: () => number;
...
export const testNativeWindowCleanCacheLoopBufferCirculation_1: () => number;
export const testNativeWindowCleanCacheLoopBufferCirculation_2: () => number;
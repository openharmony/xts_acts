...
napi_value testNativeWindowCleanCacheLoopBufferCirculation_1(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;
...
napi_value testNativeWindowCleanCacheLoopBufferCirculation_2(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;

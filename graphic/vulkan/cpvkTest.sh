...
cp -rf "$root_libuv_path/third_party/vk-gl-cts/external/vulkancts/mustpass/master/vk-default" "suites/acts/testcases/vulkandata"
cp -rf "$root_libuv_path/third_party/vk-gl-cts/external/vulkancts/mustpass/master/src/fraction-mandatory-tests.txt" "suites/acts/testcases/vulkandata/vk-default"
cp -rf "$root_libuv_path/third_party/vk-gl-cts/external/vulkancts/mustpass/master/src/master.txt" "suites/acts/testcases/vulkandata/vk-default"
cp -rf "$root_libuv_path/third_party/vk-gl-cts/external/vulkancts/mustpass/master/src/test-issues.txt" "suites/acts/testcases/vulkandata/vk-default"
cp -rf "$root_libuv_path/third_party/vk-gl-cts/external/vulkancts/data/vulkan" "suites/acts/testcases/vulkandata"

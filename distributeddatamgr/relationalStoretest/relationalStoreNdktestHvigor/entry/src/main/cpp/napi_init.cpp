...
static napi_value OH_Rdb_SetSecurityLevel_0200(napi_env env, napi_callback_info info)
{
    ...
    NAPI_ASSERT(env, errcode == OH_Rdb_ErrCode::RDB_E_INVALID_ARGS, "OH_Rdb_SetSecurityLevel(config, NULL) err is fail.");

...
export default function FileShare_RevokePermission_test() {
    describe('RevokePermission_test', function () {
      ...
      * @tc.require
      */
      it('FileShare_revokePermission_001', 0, async function (done) {
          try {
      ...
      * @tc.require
      */
      it('FileShare_revokePermission_002', 0, async function (done) {
          try {
      ...
      * @tc.require
      */
      it('FileShare_revokePermission_003', 3, async function (done) {
          try {
          let fileStr = "/data/storage/el2/base/haps/entry/files/FileShare_revokePermission_003.txt";
          let uriObject = new fileuri.FileUri(fileStr);
          let uri = uriObject.toString();
          let policyInfo = {
              uri: uri, 

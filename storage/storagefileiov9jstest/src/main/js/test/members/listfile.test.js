...
export default function fileIOListfile() {
  ...
  */
   ...
   * @tc.desc Test listFile() interface. return in Callback mode.
   * Only path, do not filter file.
   * @tc.size MEDIUM
   * @tc.type Function
   * @tc.level Level 0
   ...
   * @tc.desc Test listFile() interface. return in Promise mode.
   * Only path, do not filter file.
   * @tc.size MEDIUM
   * @tc.type Function
   * @tc.level Level 0
  ...
  * @tc.desc Test listFile()interfaces.return in Callback mode.
  * Do not have prop filter.Filter files by quantity only.
  * @tc.size MEDIUM
  * @tc.type Function
  * @tc.level Level 0
  ...
  */
   ...
   * @tc.desc Test listFile() interfaces.return in Promise mode.
   * Do not have prop filter.Filter files by quantity only.
   * @tc.size MEDIUM
   * @tc.type Function
   * @tc.level Level 0
    ...
    try {
      ...
      fileIO.listFile(dpath, {
        ...
        filter:{
          ...
          if (err) {
              console.log('fileIO_test_listfile_async_012 err package ' + JSON.stringify(err));
              expect(false).assertTrue();
          }
          expect(false).assertTrue();
      });
  ...
  it('fileIO_test_listfile_async_013', 0, async function (done) {
    ...
    try {
      ...
      await fileIO.listFile(dpath, {
        ...
        filter:{
          suffix: ["%.txt%"],
          displayName: ["*listfile_async_013*"],
          fileSizeOver: 0,
          lastModifiedAfter: time -3
        }
        });
      ...
      expect(err.code == 13900020 && err.message == 'Invalid argunment').assertTrue;
      done();
    }
  });

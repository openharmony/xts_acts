...
static napi_value GetFullDirectoryUri(napi_env env, napi_callback_info info){
    char uri[] = "file://com.acts.storage.fileurindk/data/storage/el2/base/haps/com.acts.storage.fileurindk/files/test3.txt";
    unsigned int length = strlen(uri);
    char *uriResult = NULL;
...
static napi_value IsValidUri(napi_env env, napi_callback_info info){
    char uri[] = "file://com.acts.storage.fileurindk/data/storage/el2/base/haps/com.acts.storage.fileurindk/files/test4.txt";
    unsigned int length = strlen(uri);

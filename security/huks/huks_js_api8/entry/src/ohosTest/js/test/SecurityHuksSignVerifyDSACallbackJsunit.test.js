...
export default function SecurityHuksSignVerifyDSACallbackJsunit() {
  describe('SecurityHuksSignVerifyDSACallbackJsunit', function () {
    it('Security_HUKS_SignVerify_API8_DSA_001', 0, async function (done) {
    ...
    it('Security_HUKS_SignVerify_API8_DSA_002', 0, async function (done) {
    ...
    it('Security_HUKS_SignVerify_API8_DSA_003', 0, async function (done) {
    ...
    it('Security_HUKS_SignVerify_API8_DSA_004', 0, async function (done) {

...
describe('SecurityHuksCipherRSACallbackJsunit', function () {
  if (Control.isOpenSSL) {
    it('testCipherRSASize512PADDINGNONESHA256001', 0, async function (done) {
    ...
    it('testCipherRSASize512PADDINGNONESHA256002', 0, async function (done) {
    ...
    it('testCipherRSASize512PADDINGNONESHA256003', 0, async function (done) {
      const srcKeyAlies = 'testCipherRSASize512PADDINGNONESHA256KeyAlias001';
      const newSrcKeyAlies =
        'testCipherRSASize512PADDINGNONESHA256NewKeyAlias001';
      let HuksOptions = {
    ...
    it('testCipherRSASize512PADDINGNONESHA256004', 0, async function (done) {
      const srcKeyAlies = 'testCipherRSASize512PADDINGNONESHA256KeyAlias002';
      const newSrcKeyAlies =
        'testCipherRSASize512PADDINGNONESHA256NewKeyAlias001';
      let HuksOptions = {
  ...
  it(
    'testCipherRSASize512PADDINGPKCS1_V1_5SHA256001',
    0,
    async function (done) {
      const srcKeyAlies =
        'testCipherRSASize512PADDINGPKCS1_V1_5SHA256KeyAlias001';
      const newSrcKeyAlies =
        'testCipherRSASize512PADDINGPKCS1_V1_5SHA256NewKeyAlias001';
      genHuksOptions.properties.splice(
        3,
        1,
        HuksCipherRSA.HuksKeyRSABLOCKMODEECB
  ...
  it(
    'testCipherRSASize512PADDINGPKCS1_V1_5SHA256002',
    0,
    async function (done) {
      const srcKeyAlies =
        'testCipherRSASize512PADDINGPKCS1_V1_5SHA256KeyAlias002';
      const newSrcKeyAlies =
        'testCipherRSASize512PADDINGPKCS1_V1_5SHA256NewKeyAlias001';
      let HuksOptions = {
        properties: new Array(
  ...
  it(
    'testCipherRSASize512PADDINGPKCS1_V1_5SHA256003',
    0,
    async function (done) {
      const srcKeyAlies =
        'testCipherRSASize512PADDINGPKCS1_V1_5SHA256KeyAlias001';
  ...
  it(
    'testCipherRSASize512PADDINGPKCS1_V1_5SHA256004',
    0,
    async function (done) {
      const srcKeyAlies =
        'testCipherRSASize512PADDINGPKCS1_V1_5SHA256KeyAlias002';
  ...
  it('testCipherRSASize512PADDINGOAEPSHA1001', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA1KeyAlias001';
    const newSrcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA1NewKeyAlias001';
    genHuksOptions.properties.splice(
      3,
      1,
      HuksCipherRSA.HuksKeyRSABLOCKMODEECB
  ...
  it('testCipherRSASize512PADDINGOAEPSHA1002', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA256KeyAlias002';
    const newSrcKeyAlies =
      'testCipherRSASize512PADDINGOAEPSHA256NewKeyAlias001';
    let HuksOptions = {
      properties: new Array(
        HuksCipherRSA.HuksKeyAlgRSA,
        HuksCipherRSA.HuksKeyPurposeENCRYPT,
  ...
  it('testCipherRSASize512PADDINGOAEPSHA1003', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA1KeyAlias001';
    const newSrcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA1NewKeyAlias001';
    let HuksOptions = {
      properties: new Array(
  ...
  it('testCipherRSASize512PADDINGOAEPSHA1004', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA1KeyAlias002';
    const newSrcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA1NewKeyAlias001';
    let HuksOptions = {
      properties: new Array(
        HuksCipherRSA.HuksKeyAlgRSA,
  ...
  it('testCipherRSASize512PADDINGOAEPSHA224001', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA224KeyAlias001';
    const newSrcKeyAlies =
      'testCipherRSASize512PADDINGOAEPSHA224NewKeyAlias001';
    genHuksOptions.properties.splice(
      3,
      1,
      HuksCipherRSA.HuksKeyRSABLOCKMODEECB
  ...
  it('testCipherRSASize512PADDINGOAEPSHA224002', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA256KeyAlias002';
    const newSrcKeyAlies =
      'testCipherRSASize512PADDINGOAEPSHA256NewKeyAlias001';
    let HuksOptions = {
  ...
  it('testCipherRSASize512PADDINGOAEPSHA224003', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA224KeyAlias001';
    const newSrcKeyAlies =
      'testCipherRSASize512PADDINGOAEPSHA224NewKeyAlias001';
    let HuksOptions = {
  ...
  it('testCipherRSASize512PADDINGOAEPSHA224004', 0, async function (done) {
    const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA224KeyAlias002';
    const newSrcKeyAlies =
      'testCipherRSASize512PADDINGOAEPSHA224NewKeyAlias001';
    let HuksOptions = {
      properties: new Array(

...
describe('SecurityHuksCipherAESPromiseJsunit', function () {
  it('testCipherAESSize128PADDINGNONEMODECBC103', 0, async function (done) {
  ...
  it('testCipherAESSize128PADDINGNONEMODECBC104', 0, async function (done) {
  ...
  it('testCipherAESSize128PADDINGPKCS7MODECBC104', 0, async function (done) {
  ...
  it('testCipherAESSize128PADDINGNONEMODECTR104', 0, async function (done) {
  ...
  it('testCipherAESSize128PADDINGNONEMODEECB103', 0, async function (done) {
  ...
  it('testCipherAESSize128PADDINGNONEMODEECB104', 0, async function (done) {
  ...
  if (Control.isOpenSSL) {
    ...
    it('testCipherAESSize128PADDINGPKCS7MODEECB104', 0, async function (done) {

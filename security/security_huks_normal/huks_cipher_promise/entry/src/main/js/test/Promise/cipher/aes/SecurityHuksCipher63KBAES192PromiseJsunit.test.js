...
describe('SecurityHuksCipherAESPromiseJsunit', function () {
  it('testCipherAESSize192PADDINGNONEMODECBC101', 0, async function (done) {
  ...
  it('testCipherAESSize192PADDINGNONEMODECBC102', 0, async function (done) {
  ...
  it('testCipherAESSize192PADDINGPKCS7MODECBC101', 0, async function (done) {
  ...
  it('testCipherAESSize192PADDINGPKCS7MODECBC102', 0, async function (done) {
  ...
  it('testCipherAESSize192PADDINGNONEMODECTR101', 0, async function (done) {
  ...
  it('testCipherAESSize192PADDINGNONEMODECTR102', 0, async function (done) {
  ...
  it('testCipherAESSize192PADDINGNONEMODEECB101', 0, async function (done) {
  ...
  it('testCipherAESSize192PADDINGNONEMODEECB102', 0, async function (done) {
  ...
  if (Control.isOpenSSL) {
    it('testCipherAESSize192PADDINGPKCS7MODEECB101', 0, async function (done) {
    ...
    it('testCipherAESSize192PADDINGPKCS7MODEECB102', 0, async function (done) {

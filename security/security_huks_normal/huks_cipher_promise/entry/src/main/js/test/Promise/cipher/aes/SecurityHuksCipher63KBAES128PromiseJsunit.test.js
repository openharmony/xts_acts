...
describe('SecurityHuksCipherAESPromiseJsunit', function () {
  it('testCipherAESSize128PADDINGNONEMODECBC101', 0, async function (done) {
  ...
  it('testCipherAESSize128PADDINGNONEMODECBC102', 0, async function (done) {
  ...
  it('testCipherAESSize128PADDINGPKCS7MODECBC101', 0, async function (done) {
    const srcKeyAlies = 'testCipherAESSize128PADDINGPKCS7MODECBCKeyAlias101';
    genHuksOptions.properties.splice(2, 1, HuksCipherAES.HuksKeyAESSize128);
  ...
  it('testCipherAESSize128PADDINGPKCS7MODECBC102', 0, async function (done) {
    const srcKeyAlies = 'testCipherAESSize128PADDINGPKCS7MODECBCKeyAlias102';
    let HuksOptions = {
      properties: new Array(
        HuksCipherAES.HuksKeyAlgAES,
        HuksCipherAES.HuksKeyPurposeENCRYPT,
  ...
  it('testCipherAESSize128PADDINGNONEMODECTR101', 0, async function (done) {
    const srcKeyAlies = 'testCipherAESSize128PADDINGNONEMODECTRKeyAlias101';
  ...
  it('testCipherAESSize128PADDINGNONEMODECTR102', 0, async function (done) {
    const srcKeyAlies = 'testCipherAESSize128PADDINGNONEMODECTRKeyAlias102';
    let HuksOptions = {
      properties: new Array(
        HuksCipherAES.HuksKeyAlgAES,
        HuksCipherAES.HuksKeyPurposeENCRYPT,
  ...
  it('testCipherAESSize128PADDINGNONEMODEECB101', 0, async function (done) {
    const srcKeyAlies = 'testCipherAESSize128PADDINGNONEMODEECBKeyAlias101';
    genHuksOptions.properties.splice(2, 1, HuksCipherAES.HuksKeyAESSize128);
    genHuksOptions.properties.splice(
      3,
      1,
  ...
  it('testCipherAESSize128PADDINGNONEMODEECB102', 0, async function (done) {
    const srcKeyAlies = 'testCipherAESSize128PADDINGNONEMODEECBKeyAlias102';
    let HuksOptions = {
      properties: new Array(
        HuksCipherAES.HuksKeyAlgAES,
        HuksCipherAES.HuksKeyPurposeENCRYPT,
  ...
  if (Control.isOpenSSL) {
    it('testCipherAESSize128PADDINGPKCS7MODEECB101', 0, async function (done) {
      const srcKeyAlies = 'testCipherAESSize128PADDINGPKCS7MODEECBKeyAlias101';
      genHuksOptions.properties.splice(2, 1, HuksCipherAES.HuksKeyAESSize128);
      genHuksOptions.properties.splice(
        3,
        1,
    ...
    it('testCipherAESSize128PADDINGPKCS7MODEECB102', 0, async function (done) {
      const srcKeyAlies = 'testCipherAESSize128PADDINGPKCS7MODEECBKeyAlias102';
      let HuksOptions = {
        properties: new Array(
          HuksCipherAES.HuksKeyAlgAES,
          HuksCipherAES.HuksKeyPurposeENCRYPT,

...
describe('SecurityHuksSignVerifyDSAPromiseJsunit', function () {
  ...
  it('testSignVerifyDSASIGNSHA224104', 0, async function (done) {
    const srcKeyAlies = 'testSignVerifyDSASIGNSHA224KeyAlias104';
  ...
  it('testSignVerifyDSASIGNSHA256104', 0, async function (done) {
    const srcKeyAlies = 'testSignVerifyDSASIGNSHA256KeyAlias104';
  ...
  it('testSignVerifyDSASIGNSHA384104', 0, async function (done) {
    const srcKeyAlies = 'testSignVerifyDSASIGNSHA384KeyAlias104';
  ...
  it('testSignVerifyDSASIGNSHA512104', 0, async function (done) {
    const srcKeyAlies = 'testSignVerifyDSASIGNSHA512KeyAlias104';

...
static napi_value OHHuksExportPublicKeyItem(napi_env env, napi_callback_info info)
{
    ...
    napi_create_async_work(env, nullptr, resourceName, doOHHuksExportPublicKeyItem, resultAsyncWork, (void *)addonData,
                           &addonData->asyncWork);
...
static napi_value OHHuksImportKeyItem(napi_env env, napi_callback_info info)
{
    ...
    napi_value resourceName = nullptr;
    napi_create_string_utf8(env, "addAsyncCallback", NAPI_AUTO_LENGTH, &resourceName);
    napi_create_async_work(env, nullptr, resourceName, doOHHuksImportKeyItem, resultAsyncWork, (void *)addonData,
                           &addonData->asyncWork);

...
static napi_value OHHuksGetSdkVersion(napi_env env, napi_callback_info info) {
    ...
    struct OH_Huks_Blob *g_keyAlias = (struct OH_Huks_Blob*)malloc(sizeof(struct OH_Huks_Blob));
    g_keyAlias->data = (uint8_t *)malloc(sizeof(uint8_t));
    struct OH_Huks_Result resultSt = OH_Huks_GetSdkVersion(g_keyAlias);
...
static napi_value OHHuksGetSdkVersionErr(napi_env env, napi_callback_info info) {
    int returnValue = FAIL;
    struct OH_Huks_Blob *g_keyAlias = new OH_Huks_Blob{};
    struct OH_Huks_Result resultSt = OH_Huks_GetSdkVersion(g_keyAlias);
...
static napi_value OHHuksGenerateKeyItem(napi_env env, napi_callback_info info) {
    ...
    struct OH_Huks_Result resultSt = OH_Huks_GenerateKeyItem(&g_keyAlias, paramSet, nullptr);
    if (resultSt.errorCode == (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksGenerateKeyItemErr(napi_env env, napi_callback_info info) {
    int returnValue = FAIL;
    struct OH_Huks_Result resultSt = OH_Huks_GenerateKeyItem(blobNullptr, paramSetNullptr, paramSetNullptr);
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksExportPublicKeyItemErr(napi_env env, napi_callback_info info) {
    int returnValue = FAIL;
    struct OH_Huks_Result resultSt = OH_Huks_ExportPublicKeyItem(blobNullptr, paramSetNullptr, blobNullptr);
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksImportKeyItemErr(napi_env env, napi_callback_info info) {
    int returnValue = FAIL;
    struct OH_Huks_Result resultSt = OH_Huks_ImportKeyItem(blobNullptr, paramSetNullptr, blobNullptr);
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksDeleteKeyItem(napi_env env, napi_callback_info info) {
    ...
    ret = OH_Huks_GenerateKeyItem(&g_keyAlias, paramSet, nullptr);
    struct OH_Huks_Result resultSt = OH_Huks_DeleteKeyItem(&g_keyAlias, nullptr);
    if (resultSt.errorCode == (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksDeleteKeyItemErr(napi_env env, napi_callback_info info) {
    int returnValue = FAIL;
    struct OH_Huks_Result resultSt = OH_Huks_DeleteKeyItem(blobNullptr, paramSetNullptr);
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksIsKeyItemExist(napi_env env, napi_callback_info info) {
    ...
    ret = OH_Huks_GenerateKeyItem(&g_keyAlias, paramSet, nullptr);
    struct OH_Huks_Result resultSt = OH_Huks_IsKeyItemExist(&g_keyAlias, paramSet);
    if (resultSt.errorCode == (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksIsKeyItemExistErr(napi_env env, napi_callback_info info) {
    int returnValue = FAIL;
    struct OH_Huks_Result resultSt = OH_Huks_IsKeyItemExist(blobNullptr, paramSetNullptr);
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value OHHuksInitSession(napi_env env, napi_callback_info info) {
    ...
    struct OH_Huks_Result resultSt = OH_Huks_InitSession(&g_keyAlias, hkdfParamSet, &handleDerive, nullptr);
...
static napi_value OHHuksInitSessionErr(napi_env env, napi_callback_info info) {
    int returnValue = FAIL;
    struct OH_Huks_Result resultSt = OH_Huks_InitSession(blobNullptr, paramSetNullptr, blobNullptr, blobNullptr);
...
static napi_value OHHuksAttestKeyItem(napi_env env, napi_callback_info info) {
    ...
    struct OH_Huks_Result resultSt = OH_Huks_AttestKeyItem(&g_keyAlias, paramSet, certChain);
    int returnValue = FAIL;
    if (resultSt.errorCode == (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksAttestKeyItemErr(napi_env env, napi_callback_info info) {
    struct OH_Huks_Result resultSt = OH_Huks_AttestKeyItem(blobNullptr, paramSetNullptr, certChainNullptr);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksAddParamsErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_AddParams(paramSetNullptr, paramNullptr, 0);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksIsParamSetValidErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_IsParamSetValid(paramSetNullptr, 0);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksIsParamSetTagValidErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_IsParamSetTagValid(paramSetNullptr);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksGetParamErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_GetParam(paramSetNullptr, 0, &paramNullptr);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksCopyParamSetErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_CopyParamSet(paramSetNullptr, 0, &paramSetNullptr);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksUpdateSessionErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_UpdateSession(blobNullptr, paramSetNullptr, blobNullptr, blobNullptr);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksFinishSessionErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_FinishSession(blobNullptr, paramSetNullptr, blobNullptr, blobNullptr);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksAbortSessionErr(napi_env env, napi_callback_info info) {
    OH_Huks_Result resultSt = OH_Huks_AbortSession(blobNullptr, paramSetNullptr);
    int returnValue = FAIL;
    if (resultSt.errorCode != (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
...
static napi_value OHHuksFinishSession(napi_env env, napi_callback_info info) {
    ...
    ret = InitParamSet(&pbkdf2ParamSet, g_pbkdf2Params001, sizeof(g_pbkdf2Params001) / sizeof(OH_Huks_Param));
    ret = InitParamSet(&pbkdf2FinishParamSet, g_pbkdf2FinishParams001, sizeof(g_pbkdf2FinishParams001) / sizeof(OH_Huks_Param));
    struct OH_Huks_Blob inData = {
        sizeof("HksPBKDF2DeriveKeyAliasTest001_1"),
        (uint8_t *)"HksPBKDF2DeriveKeyAliasTest001_1"};
...
static napi_value OHHuksGetKeyItemParamSet(napi_env env, napi_callback_info info) {
    ...
    struct OH_Huks_Result resultSt = OH_Huks_GetKeyItemParamSet(&g_keyAlias,nullptr,paramSetOut);
    if (resultSt.errorCode == (int32_t)OH_HUKS_SUCCESS) {
        returnValue = SUCCESS;
    }
    napi_value result = nullptr;
...
static napi_value Init(napi_env env, napi_value exports) {
    napi_property_descriptor desc[] = {
        ...
        {"oHHuksGenerateKeyItemErr", nullptr, OHHuksGenerateKeyItemErr, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksExportPublicKeyItem", nullptr, OHHuksExportPublicKeyItem, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksExportPublicKeyItemErr", nullptr, OHHuksExportPublicKeyItemErr, nullptr, nullptr, nullptr, napi_default, nullptr},
        ...
        {"oHHuksIsParamSetValidErr", nullptr, OHHuksIsParamSetValidErr, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksIsParamSetTagValid", nullptr, OHHuksIsParamSetTagValid, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksIsParamSetTagValidErr", nullptr, OHHuksIsParamSetTagValidErr, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksCheckParamMatch", nullptr, OHHuksCheckParamMatch, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksCheckParamMatchErr", nullptr, OHHuksCheckParamMatchErr, nullptr, nullptr, nullptr, napi_default, nullptr},
        ...
        {"oHHuksGetKeyItemParamSet", nullptr, OHHuksGetKeyItemParamSet, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksGetKeyItemParamSetErr", nullptr, OHHuksGetKeyItemParamSetErr, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksImportWrappedKeyItem", nullptr, OHHuksImportWrappedKeyItem, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHHuksImportWrappedKeyItemErr", nullptr, OHHuksImportWrappedKeyItemErr, nullptr, nullptr, nullptr, napi_default, nullptr},
    };

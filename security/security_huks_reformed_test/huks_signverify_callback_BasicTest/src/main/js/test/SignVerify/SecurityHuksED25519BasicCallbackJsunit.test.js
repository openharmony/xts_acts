...
describe('SecurityHuksED25519BasicCallbackJsunit', function () {
  it('testSignVerifyED25519001_reformed', 0, async function (done) {
  ...
  it('testSignVerifyED25519002_reformed', 0, async function (done) {
  ...
  it('testSignVerifyED25519003_reformed', 0, async function (done) {
  ...
  it('testSignVerifyED25519004_reformed', 0, async function (done) {

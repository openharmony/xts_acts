...
describe('SecurityHuksCipherAESCallbackJsunit', function () {
  it('testCipherAES001_reformed', 0, async function (done) {
  ...
  it('testCipherAES002_reformed', 0, async function (done) {
  ...
  it('testCipherAES003_reformed', 0, async function (done) {
  ...
  it('testCipherAES004_reformed', 0, async function (done) {
    const srcKeyAlies = 'testCipherAESSize128PADDINGNONEMODECBCKeyAlias002';
    let HuksOptions = {
      properties: new Array(
        HuksCipherAES.HuksKeyAlgAES,

...
describe('SecurityHuksED25519BasicPromiseJsunit', function () {
  it('testSignVerifyED25519101_reformed', 0, async function (done) {
  ...
  it('testSignVerifyED25519102_reformed', 0, async function (done) {
  ...
  it('testSignVerifyED25519103_reformed', 0, async function (done) {
  ...
  it('testSignVerifyED25519104_reformed', 0, async function (done) {

...
import {
    HuksDeriveHKDF,
    HuksDerivePBKDF2
} from '../../../../../../utils/param/derive/publicDeriveParam';
import {
    HuksHmac
...
export default function SecurityHuksRSASignExtendJsunit() {
    describe('SecurityHuksRSASignExtendJsunit', function () {
        ...
        /**
         * @tc.number Security_HUKS_Cipher_AnonAttestation_0011
         * @tc.name Test AnonAttestation with X25519, process is success ...
         * @tc.desc generateKeyItem with X25519 ...
         * @tc.level Level3
         * @tc.type Func
         * @tc.size Medium
         */
        it("Security_HUKS_Cipher_AnonAttestation_0011", 0, async function (done) {
            let srcKeyAlies = "Security_HUKS_Cipher_AnonAttestation_0011";
            let properties = [
                {
                    tag: huks.HuksTag.HUKS_TAG_ATTESTATION_ID_SEC_LEVEL_INFO,
                    value: stringToUint8Array('sec_level')

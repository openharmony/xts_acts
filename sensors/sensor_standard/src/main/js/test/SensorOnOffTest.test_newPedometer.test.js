...
describe("SensorJsTest_sensor_56", function () {
     ...
     */
    it("newPedometer_SensorJsTest012", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
        console.info('--------newPedometer_SensorJsTest012--------');
		try {
            sensor.on(sensor.SensorId.PEDOMETER, callback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest012 error:" + error);
    ...
    it("newPedometer_SensorJsTest013", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
		...
		try {
            ...
            console.info("newPedometer_SensorJsTest013 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest014", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest014  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.on(sensor.SensorId.PEDOMETER, 
			onSensorCallback, { 'interval': 100000000 }, 5);
        } catch (error) {
            console.info("newPedometer_SensorJsTest014 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest015", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
		...
		sensor.once(sensor.SensorId.PEDOMETER, callback);
            ...
            console.info("newPedometer_SensorJsTest015 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
			done();
        }
    ...
    it("newPedometer_SensorJsTest016", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onceSensorCallback(data) {
            console.info('newPedometer_SensorJsTest016 on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.once(sensor.SensorId.PEDOMETER, onceSensorCallback, 5);
        } catch (error) {
            console.info("newPedometer_SensorJsTest016 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
   ...
   /*
    ...
    it("newPedometer_SensorJsTest017", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        try {
			...
			errMessage 
            console.info("newPedometer_SensorJsTest017 error:" + error);
   ...
   /*
    ...
    it("newPedometer_SensorJsTest018", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest018  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
       try {
		   sensor.on(sensor.SensorId.PEDOMETER, onSensorCallback);
           sensor.off(sensor.SensorId.PEDOMETER);
            } catch (error) {
            console.info("newPedometer_SensorJsTest018 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest019", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest019  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.off(1000000, onSensorCallback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest019 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest020", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest020  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.off(invalid, onSensorCallback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest020 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest021", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest021  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.xxx(sensor.SensorId.PEDOMETER, onSensorCallback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest021 error:" + error);
            errMessage = error.toString();
    ...
    it("newPedometer_SensorJsTest022", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        console.info('--------newPedometer_SensorJsTest022--------');
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest022  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            xxx.on(sensor.SensorId.PEDOMETER, onSensorCallback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest022 error:" + error);
            errMessage = error.toString();

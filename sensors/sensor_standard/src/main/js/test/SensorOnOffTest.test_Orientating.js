...
describe("SensorJsTest_sensor_16", function () {
     ...
     */
    it("orientating_SensorJsTest003", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
     ...
     */
    it("orientating_SensorJsTest005", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {

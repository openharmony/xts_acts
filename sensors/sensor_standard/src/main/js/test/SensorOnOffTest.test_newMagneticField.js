...
describe("SensorJsTest_sensor_37", function () {
	...
	/*
     * @tc.number:SUB_SensorSystem_MAGNETIC_FIELD_JsTest_0140
    ...
    it("newMagneticField_SensorJsTest015", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newMagneticField_SensorJsTest015 callback in');
     ...
     */
    it("newMagneticField_SensorJsTest017", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        console.info('---------newMagneticField_SensorJsTest017--------------');
        function onSensorCallback(data) {
            console.info('newMagneticField_SensorJsTest017  callback in');
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0190
    ...
    it("newMagneticField_SensorJsTest019", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onceSensorCallback(data) {
            console.info('newMagneticField_SensorJsTest019 callback in');
            expect(false).assertTrue();
            done();
        }
        try {
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0200
     * @tc.name: newMagneticField_SensorJsTest020
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newMagneticField_SensorJsTest020", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        function onceSensorCallback(data) {
            console.info('newMagneticField_SensorJsTest020  on error');
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0210
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0220
    ...
    it("newMagneticField_SensorJsTest022", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onSensorCallback(data) {
            console.info('newMagneticField_SensorJsTest022 callback in');
            expect(false).assertTrue();
            done();
        }
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0230
    ...
    it("newMagneticField_SensorJsTest023", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onSensorCallback(data) {
            console.info('newMagneticField_SensorJsTest023 on error');
            expect(false).assertTrue();
        }
        try {
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0240
    ...
    it("newMagneticField_SensorJsTest024", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        sensor.on(sensor.SensorId.MAGNETIC_FIELD, (data)=>{
            console.info("newMagneticField_SensorJsTest024 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0250
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0260
    ...
    it("newMagneticField_SensorJsTest026", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        sensor.once(sensor.SensorId.MAGNETIC_FIELD, (data)=>{
            console.info("newMagneticField_SensorJsTest026 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0270
     * @tc.name: newMagneticField_SensorJsTest027
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newMagneticField_SensorJsTest027", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        sensor.on(sensor.SensorId.MAGNETIC_FIELD, (data)=>{
            console.info("newMagneticField_SensorJsTest027 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        setTimeout(()=>{
            console.info('---------newMagneticField_SensorJsTest027 off in--------------');
            sensor.off(sensor.SensorId.MAGNETIC_FIELD);
	...
	/*
     * @tc.number:SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0280
     * @tc.name: newMagneticField_SensorJsTest028
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newMagneticField_SensorJsTest028", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        console.info('---------newMagneticField_SensorJsTest028--------------');
        try {
            sensor.on();
        } catch (error) {
	 ...
	 /*
     * @tc.number: SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0290
     * @tc.name: newMagneticField_SensorJsTest029
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newMagneticField_SensorJsTest029", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        setTimeout(() => {
            console.info('----------------------newMagneticField_SensorJsTest029 off in--------------');
            try {
			sensor.off(sensor.SensorId.MAGNETIC_FIELD, callback);
			} catch (error) {
            console.info("newMagneticField_SensorJsTest029 error:" + error);
			}
	 ...
	 /*
     * @tc.number: SUB_SensorsSystem_MAGNETIC_FIELD_JSTest_0300
     * @tc.name: newMagneticField_SensorJsTest030
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newMagneticField_SensorJsTest030", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        setTimeout(() => {
            console.info('----------------------newMagneticField_SensorJsTest030 off in--------------');
            try {
			sensor.off(sensor.SensorId.MAGNETIC_FIELD, callback);
			} catch (error) {
            console.info("newMagneticField_SensorJsTest030 error:" + error);
			}
            console
            console.info('----------------------newMagneticField_SensorJsTest030 off end--------------');
        }, 500);
        setTimeout(() => {
            console.info('----------------------newMagneticField_SensorJsTest030_2 off in--------------');
            sensor.off(sensor.SensorId.MAGNETIC_FIELD, callback2);

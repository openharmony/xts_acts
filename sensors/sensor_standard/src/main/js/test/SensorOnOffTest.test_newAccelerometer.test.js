...
describe("SensorJsTest_sensor_39", function () {
     ...
     */
    it("newAccelerometer_SensorJsTest014", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
    ...
    it("newAccelerometer_SensorJsTest015", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newAccelerometer_SensorJsTest015 callback in');
            expect(false).assertTrue();
        }
        try {
            sensor.on(invalid, onSensorCallback);
        } catch (error) {
            console.info("newAccelerometer_SensorJsTest015 error:" + error);
     ...
     */
    it("newAccelerometer_SensorJsTest017", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        console.info('---------newAccelerometer_SensorJsTest017--------------');
        function onSensorCallback(data) {
            console.info('newAccelerometer_SensorJsTest017  callback in');
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
    ...
    it("newAccelerometer_SensorJsTest019", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onceSensorCallback(data) {
            console.info('newAccelerometer_SensorJsTest019 callback in');
            expect(false).assertTrue();
            done();
        }
        try {
	...
	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0200
     * @tc.name: newAccelerometer_SensorJsTest020
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newAccelerometer_SensorJsTest020", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        function onceSensorCallback(data) {
            console.info('newAccelerometer_SensorJsTest020  on error');
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
	...
	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0210
	...
	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0220
    ...
    it("newAccelerometer_SensorJsTest022", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onSensorCallback(data) {
            console.info('newAccelerometer_SensorJsTest022 callback in' + JSON.stringify(data));
            expect(false).assertTrue();
            done();
        }
	...
	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0230
    ...
    it("newAccelerometer_SensorJsTest023", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onSensorCallback(data) {
            console.info('newAccelerometer_SensorJsTest023 on error'  + JSON.stringify(data));
            expect(false).assertTrue();
            done();
        }
        try {
	...
	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0240
    ...
    it("newAccelerometer_SensorJsTest024", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        sensor.on(sensor.SensorId.ACCELEROMETER, (data)=>{
            console.info("newAccelerometer_SensorJsTest024 callback: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        sensor.on(sensor.SensorId.ACCELEROMETER, (data)=>{
            console.info("newAccelerometer_SensorJsTest024 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
	...
	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0250
	...
	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0260
     * @tc.name: newAccelerometer_SensorJsTest026
     * @tc.desc:Call on interface and once interface respectively, and use an off interface to close
     */
    it("newAccelerometer_SensorJsTest026", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        console.info('---------newAccelerometer_SensorJsTest026--------------');
        sensor.on(sensor.SensorId.ACCELEROMETER, (data)=>{
            console.info("newAccelerometer_SensorJsTest026 callback: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        sensor.once(sensor.SensorId.ACCELEROMETER, (data)=>{
            console.info("newAccelerometer_SensorJsTest026 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        setTimeout(()=>{
            console.info('---------newAccelerometer_SensorJsTest026 off in--------------');
            sensor.off(sensor.SensorId.ACCELEROMETER);
            console.info('---------newAccelerometer_SensorJsTest026 off end--------------');
            done();
        }, 1000);
    })

	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0270
     * @tc.name: newAccelerometer_SensorJsTest027
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newAccelerometer_SensorJsTest027", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        console.info('---------newAccelerometer_SensorJsTest027--------------');
        sensor.on(sensor.SensorId.ACCELEROMETER, (data)=>{
            console.info("newAccelerometer_SensorJsTest027 callback: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        sensor.on(sensor.SensorId.ACCELEROMETER, (data)=>{
            console.info("newAccelerometer_SensorJsTest027 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        setTimeout(()=>{
            console.info('---------newAccelerometer_SensorJsTest027 off in--------------');
            sensor.off(sensor.SensorId.ACCELEROMETER);
            console.info('---------newAccelerometer_SensorJsTest027 off end--------------');
            done();
        }, 1000);
    })

	/*
     * @tc.number:SUB_SensorsSystem_ACCELEROMETER_JSTest_0280
     * @tc.name: newAccelerometer_SensorJsTest028
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newAccelerometer_SensorJsTest028", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        console.info('---------newAccelerometer_SensorJsTest028--------------');
        try {
            sensor.on();
        } catch (error) {
			console.info("newAccelerometer_SensorJsTest028 on error:" +error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
        try {
			...
			console.info("newAccelerometer_SensorJsTest028 once error:" +error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
        try {
			...
			console.info("newAccelerometer_SensorJsTest028 off error:" +error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
     ...
     * @tc.name: newAccelerometer_SensorJsTest029
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newAccelerometer_SensorJsTest029", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        console.info('----------------------newAccelerometer_SensorJsTest029--------------');
        sensor.on(sensor.SensorId.ACCELEROMETER, callback);
        sensor.on(sensor.SensorId.ACCELEROMETER, callback2);
        setTimeout(() => {
            console.info('----------------------newAccelerometer_SensorJsTest029 off in--------------');
            try {
			sensor.off(sensor.SensorId.ACCELEROMETER, callback);
			} catch (error) {
            console.info("newAccelerometer_SensorJsTest029 error:" + error);
			}
            console.info('----------------------newAccelerometer_SensorJsTest029 off end--------------');
        }, 1000);
        setTimeout(() => {
            console.info('----------------------newAccelerometer_SensorJsTest029 off in--------------');
	 ...
	 /*
     * @tc.number: SUB_SensorsSystem_ACCELEROMETER_JSTest_0300
     * @tc.name: newAccelerometer_SensorJsTest030
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newAccelerometer_SensorJsTest030", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        console.info('----------------------newAccelerometer_SensorJsTest030--------------');
        sensor.on(sensor.SensorId.ACCELEROMETER, callback, { 'interval': 100000000 });
        sensor.on(sensor.SensorId.ACCELEROMETER, callback2, { 'interval': 100000000 });
        setTimeout(() => {
            console.info('----------------------newAccelerometer_SensorJsTest030 off in--------------');
            try {
			sensor.off(sensor.SensorId.ACCELEROMETER, callback);
			} catch (error) {
            console.info("newAccelerometer_SensorJsTest030 error:" + error);
			}
            console
            console.info('----------------------newAccelerometer_SensorJsTest030 off end--------------');
        }, 1000);
        setTimeout(() => {
            console.info('----------------------newAccelerometer_SensorJsTest030_2 off in--------------');
            sensor.off(sensor.SensorId.ACCELEROMETER, callback2);
            console.info('----------------------newAccelerometer_SensorJsTest030_2 off end--------------');
            done();
        }, 1000);
    })
})}

...
#define IS_CLEARPLAY "com.clearplay.drm"
#define IS_WISEPLAY "com.wiseplay.drm"
...
static const char *judge_uuid() {
    bool isSupport = OH_MediaKeySystem_IsSupported(IS_CLEARPLAY);
    if (isSupport == 1) {
        return IS_CLEARPLAY;
    } else {
        return IS_WISEPLAY;

...
public:
    ...
    // Image Receiver
    Image_ErrorCode CreateImageReceiver(uint32_t width, uint32_t height, uint32_t capicity);
...
private:
    bool ReuseSameRecevier(uint32_t width, uint32_t height, uint32_t capicity);

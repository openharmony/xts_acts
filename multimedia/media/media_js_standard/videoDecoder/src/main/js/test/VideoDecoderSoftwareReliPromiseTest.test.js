...
describe('VideoDecoderSoftwareReliPromiseTest', function () {
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0100
        ...
        * @tc.level     : Level0
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0100', 0, async function (done) {
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0200
        ...
        * @tc.level     : Level0
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0200', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0300
        ...
        * @tc.level     : Level0
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0300', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
            DECODE_STEP.WAIT_FOR_ALL_OUTS);
        eosFrameId = 10;
        workdoneAtEOS = true;
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0400
        ...
        * @tc.level     : Level0
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0500
        ...
        * @tc.level     : Level0
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_FUNCTION_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0100', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
    * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0200
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0200', 0, async function (done) {
    ...
    /* *
    * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0300
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0300', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
            DECODE_STEP.CONFIGURE, DECODE_STEP.ERROR, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })
    ...
    /* *
    * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0400
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
    * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0500
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
    * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0600
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0600', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
    * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0700
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0700', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.RESET, DECODE_STEP.CONFIGURE, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
    * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0800
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0800', 0, async function (done) {
    ...
    * @tc.level     : Level2
    */ 
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_CONFIGURE_PROMISE_0900', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.RESET, DECODE_STEP.CONFIGURE, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0100
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0100', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.PREPARE, DECODE_STEP.ERROR, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0200
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0200', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE,
            DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0300', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0400
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0600
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0600', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0700
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0700', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_PREPARE_PROMISE_0800', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0100
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0100', 0, async function (done) {
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0200', 0, async function (done) {
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0300', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
            DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0500
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0600
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0600', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0700
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0700', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0800
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_START_PROMISE_0800', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0100
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0100', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.FLUSH, DECODE_STEP.ERROR, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0200
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0200', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.FLUSH, DECODE_STEP.ERROR, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0300
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0300', 0, async function (done) {
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0400
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0500
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0600', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0700
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0700', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_FLUSH_PROMISE_0800', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0100
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0100', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.STOP, DECODE_STEP.ERROR, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0200
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0200', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.STOP, DECODE_STEP.ERROR, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0300
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0300', 0, async function (done) {
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0400
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0500
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0600
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0600', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0700
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0700', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0800
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_STOP_PROMISE_0800', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0100
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0100', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.RESET, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })

    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0200
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0200', 0, async function (done) {
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0300', 0, async function (done) {
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0400
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
            DECODE_STEP.RESET, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0500
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0600
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0600', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
            DECODE_STEP.STOP, DECODE_STEP.RESET, DECODE_STEP.RELEASE);
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    })
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0700
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0700', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_RESET_PROMISE_0800', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_EOS_PROMISE_0100', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_EOS_PROMISE_0200', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
            DECODE_STEP.WAIT_FOR_EOS, DECODE_STEP.FLUSH, DECODE_STEP.RELEASE);
        eosFrameId = 10;
        toCreateVideoDecoderByName('avdec_h264', mySteps, done);
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_EOS_PROMISE_0300
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_EOS_PROMISE_0300', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_EOS_PROMISE_0400', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,
    ...
    /* *
        * @tc.number    : SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_EOS_PROMISE_0500
        ...
        * @tc.level     : Level2
    */
    it('SUB_MULTIMEDIA_MEDIA_VIDEO_SOFTWARE_DECODER_API_EOS_PROMISE_0500', 0, async function (done) {
        let mySteps = new Array(DECODE_STEP.CONFIGURE, DECODE_STEP.SETSURFACE, DECODE_STEP.PREPARE, DECODE_STEP.START,

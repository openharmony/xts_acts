...
async function playTimeCallback(avPlayer, done) {
    let surfaceID = globalThis.value;
    let start;
    let end;
    let execution;
...
async function pauseTimeCallback(avPlayer, done) {
    let surfaceID = globalThis.value;
    let start;
    let end;
    let execution;
...
async function setSpeedTimeCallback(avPlayer, done) {
    let surfaceID = globalThis.value;
    let start;
    let end;
    let execution;

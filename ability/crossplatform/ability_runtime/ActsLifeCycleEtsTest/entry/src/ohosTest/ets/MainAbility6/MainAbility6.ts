...
export default class MainAbility6 extends Ability {
  ...
  onWindowStageCreate(windowStage) {
    ...
    windowStage.loadContent('TestAbility/pages/index6', (err: BusinessError) => {
      if (err.code) {
        console.log('MainAbility6 loadContent error');
        return;
      }
      console.log('MainAbility6 loadContent success');
    });
  }

...
const NAME = "Sample_012";
@Sendable
export default class Sample_012 extends StartupTask {
  async init(context) {
    hilog.info(0x0000, 'StartupTest', '%{public}s', NAME);
    console.info("StartupTest Sample_012 init");
  ...
  onDependencyCompleted(dependence: string, result) {
    ...
    console.info("StartupTest Sample_012 onDependencyCompleted dependence=" + dependence);
    console.info("StartupTest Sample_012 onDependencyCompleted result=" + JSON.stringify(result));
  }
}
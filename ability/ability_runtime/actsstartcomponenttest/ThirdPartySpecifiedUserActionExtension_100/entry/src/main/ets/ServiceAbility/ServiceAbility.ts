    ...
    switch (globalThis.startnum) {
      case 1:
        ...
        this.context.startAbilityWithAccount(
          ...
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0100 ====>success!")
        })
        console.debug("====>case 1 end====>");
        var myStub = new Stub("com.example.actsthirdpartyspecifieduseractionextensionzerotest.MainAbility");
      ...
      case 2:
        ...
        this.context.startAbilityWithAccount(
          ...
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0300 ====>success!")
        })
        ...
        this.context.startAbilityWithAccount(
          {
            ...
            abilityName: 'com.example.actsthirdpartyspecifieduseractionextensiononetest.MainAbility2'
          },101,((err, data) => {
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0500====>fail!!!"+ JSON.stringify(err))
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0500====>sunccess!"+ JSON.stringify(data))
        }))
      ...
      case 4:
        ...
        this.context.startAbilityWithAccount(
          ...
          displayId: 1
            ...
            console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0600====>fail!!!"+ JSON.stringify(err))
            console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0600====>sunccess!"+ JSON.stringify(data))
          }))
      ...
      case 5:
        ...
        this.context.startAbilityWithAccount(
          ...
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0700====>success!"+ JSON.stringify(data))
        })
        break;
      case 6:
        ...
        this.context.startAbilityWithAccount(
            {
              ...
              console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0900====>fail!!!")
              console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_0900====>sunccess!")
        }))
      ...
      case 7:
        ...
        this.context.startAbilityWithAccount(
          ...
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_1100====>fail!!!"+ JSON.stringify(err))
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_1100====>sunccess!"+ JSON.stringify(data))
        }))
      ...
      case 8:
        ...
        this.context.startAbilityWithAccount(
          ...
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_1200====>fail!!!"+ JSON.stringify(err))
          console.log("====>end ACTS_ThirdPartyStartServiceAbilityWithAccount_1200====>sunccess!"+ JSON.stringify(data))
        }))

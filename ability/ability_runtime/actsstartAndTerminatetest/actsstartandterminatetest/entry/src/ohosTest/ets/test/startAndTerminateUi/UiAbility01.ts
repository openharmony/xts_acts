...
export default class UiAbility001 extends UIAbility {
  onCreate(want, launchParam) {
    console.info('UiAbility01 onCreate');
  ...
  onDestroy() {
    console.info('UiAbility01 onDestroy');
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    commonEventManager.publish('ACTS_TEST_START02', function () {
      console.info('SUB_Ability_AbilityRuntime_StartAndTerminate_StartAbility_0100 publish ACTS_TEST_START02');
    });
  ...
  onBackground() {
    ...
    console.info('UiAbility01 onBackground');

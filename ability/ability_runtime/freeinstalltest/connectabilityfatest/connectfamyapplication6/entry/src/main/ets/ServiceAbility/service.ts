...
export default {
    onStart() {
        console.info('ServiceAbility myapp0 onStart');
    },
    onStop() {
        console.info('ServiceAbility myapp0 onStop');
    },
    onCommand(want, startId) {
        console.info('ServiceAbility myapp0 onCommand');
    },
    onConnect(want) {
        console.info('ServiceAbility myapp0 onConnect');
        console.info('featureAbility_connectAbility connect myapp0 Servcie_feature success');

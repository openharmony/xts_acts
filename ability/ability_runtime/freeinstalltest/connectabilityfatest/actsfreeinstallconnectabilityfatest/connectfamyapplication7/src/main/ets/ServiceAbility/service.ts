...
export default {
    onStart() {
        console.info('ServiceAbility myapp7 onStart');
    },
    onStop() {
        console.info('ServiceAbility myapp7 onStop');
    },
    onCommand(want, startId) {
        console.info('ServiceAbility myapp7 onCommand');
    },
    onConnect(want) {
        console.info('ServiceAbility myapp7 onConnect');
        console.info('featureAbility_connectAbility connect myapp7 Servcie_feature success');

...
export default {
    onStart() {
        console.info('ServiceAbility myapp4 onStart');
    },
    onStop() {
        console.info('ServiceAbility myapp4 onStop');
    },
    onCommand(want, startId) {
        console.info('ServiceAbility myapp4 onCommand');
    },
    onConnect(want) {
        console.info('ServiceAbility myapp4 onConnect');
        console.info('featureAbility_connectAbility connect myapp4 Servcie_feature success');

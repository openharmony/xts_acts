...
export default {
    onStart() {
        console.info('ServiceAbility myapp2 onStart');
    },
    onStop() {
        console.info('ServiceAbility myapp2 onStop');
    },
    onCommand(want, startId) {
        console.info('ServiceAbility myapp2 onCommand');
    },
    onConnect(want) {
        console.info('ServiceAbility myapp2 onConnect');
        console.info('featureAbility_connectAbility connect myapp2 Servcie_feature success');

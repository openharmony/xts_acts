...
const TAG: string = 'testTag-MainAbility7 ';
let result:number = 0;
export default class MainAbility7 extends AbilityStage  {
    onCreate() {
    ...
    onDestroy() {
        ...
        console.log("[Demo] MainAbility7 result=",result);
    }
    ...
    onWindowStageWillDestroy(){
        console.log("[Demo] MainAbility7 onWindowStageWillDestroy");
    }

    onAcceptWant(want: Want): string {
        console.log("[Demo] MainAbility7 onAcceptWant");
        return "1"
    }
    onNewWant(want: Want): string {
        console.log("[Demo] MainAbility7 onNewWant");
        return "1";
    }
};

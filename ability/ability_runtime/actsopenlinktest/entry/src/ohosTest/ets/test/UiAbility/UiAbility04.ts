...
export default class UiAbility04 extends UIAbility {
  onCreate(want, launchParam) {
    ...
    if(want.parameters.appLinkingOnly == true){
      console.info('====>SUB_Ability_AbilityRuntime_ABILITY_StartAbility_OpenLink_2200 appLinkingOnly==true');
    }
  }
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    windowStage.loadContent('testability/pages/UiAbility04', (err, data) => {
      if (err.code) {

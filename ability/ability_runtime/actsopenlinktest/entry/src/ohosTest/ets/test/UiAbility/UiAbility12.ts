...
export default class UiAbility12 extends UIAbility {
  onCreate(want) {
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    console.info('UiAbility12 onWindowStageCreate');
  ...
  onForeground() {
    ...
    console.info('UiAbility12 onForeground');
    hilog.info(0x0000, 'testTag', '%{public}s', 'Ability onForeground');
  }

  onBackground() {
    // Ability has back to background
    console.info('UiAbility12 onBackground');

...
export default class UiAbility19 extends UIAbility {
  onCreate(want) {
    console.info('UiAbility19 onCreate');
    hilog.info(0x0000, 'testTag', '%{public}s', 'Ability onCreate');
    let uri = want?.uri
    console.info('UiAbility19 JSON.stringify(want) is', JSON.stringify(want));
    console.info('UiAbility19 JSON.stringify(want) is', JSON.stringify(want.parameters));
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    console.info('UiAbility19 onWindowStageCreate');
  ...
  onForeground() {
    ...
    console.info('UiAbility19 onForeground');
    hilog.info(0x0000, 'testTag', '%{public}s', 'Ability onForeground');
  }

  onBackground() {
    console.info('UiAbility19 onBackground');

...
export default class FeatureAbility extends UIAbility {
  onCreate(want, launchParam) {
    ...
    if (want.action === 'Acts_ShareExtensionAbility_0400') {
      console.info("====>FeatureAbility want.action == 'Acts_ShareExtensionAbility_0400':");
    ...
    if (want.action === 'Acts_ShareExtensionAbility_0200') {
      console.info("====>FeatureAbility want.action == 'Acts_ShareExtensionAbility_0200':");
      AppStorage.SetOrCreate('want', {
        bundleName: 'com.example.actsshareextensionabilitytest',

...
OptionArray:{icon:"common/images/icon.png",content:"复制"},
    ...
    onShow(){
        ...
        globalThis.value = {
            ...
            hintNone :  this.hintNone,
            hint :  this.hint,
            searchbuttonNone :  this.searchbuttonNone,
    ...
    getSpecificPropValues(){
        ...
        this.hintNone = this.$element("hintNone").getInspector()
        this.hint = this.$element("hint").getInspector()
        this.searchbuttonNone = this.$element("searchbuttonNone").getInspector()
        this.searchbutton = this.$element("searchbutton").getInspector()

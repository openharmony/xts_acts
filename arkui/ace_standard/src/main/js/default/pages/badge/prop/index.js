 ...
 export default {
     ...
     onShow(){
         ...
         globalThis.value = {
             ...
             placementRight:this.placementRight,
             placementRightTop:this.placementRightTop,
             placementLeft:this.placementLeft,
             placementNone:this.placementNone,
             count:this.count,
             visibleTrue:this.visibleTrue,
             visibleFalse:this.visibleFalse,
             visibleNone:this.visibleNone,
             maxcount:this.maxcount,
             maxcountNone:this.maxcountNone,
             config:this.config,
             configNone:this.configNone,
             label:this.label,
             labelNone:this.labelNone,
         }
     },
     ...
     getSpecificPropValues(){
         this.placementRight = this.$element("placementRight").getInspector()
         this.placementRightTop = this.$element("placementRightTop").getInspector()
         this.placementLeft = this.$element("placementLeft").getInspector()
         this.placementNone = this.$element("placementNone").getInspector()
         this.count = this.$element("count").getInspector()
         this.visibleTrue = this.$element("visibleTrue").getInspector()
         this.visibleFalse = this.$element("visibleFalse").getInspector()
         this.visibleNone = this.$element("visibleNone").getInspector()
         this.maxcount = this.$element("maxcount").getInspector()
         this.maxcountNone = this.$element("maxcountNone").getInspector()
         this.config = this.$element("config").getInspector()
         this.configNone = this.$element("configNone").getInspector()
         this.label = this.$element("label").getInspector()
         this.labelNone = this.$element("labelNone").getInspector()
     }
 }

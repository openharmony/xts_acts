...
export default {
    ...
    getCommonPropValues(){
        ...
        this.x1Prop = this.$element("x1Prop").getInspector()
        this.x2Prop = this.$element("x2Prop").getInspector()
        this.y1Prop = this.$element("y1Prop").getInspector()
        this.y2Prop = this.$element("y2Prop").getInspector()

...
export default {
    ...
    openStyle1(){
        this.$element('Style1').show()
    },
    openStyle2(){
        this.$element('Style2').show()
    },
    openAni1(){
        this.$element('ani1').show()
    },
    openprop1(){
    ...
    openprop3(){
        this.$element('prop3').show()
    },
    openevent(){
        this.$element('event').show()
    },
    close(){
        this.$element('event').close()
    },
    opengradient1(){
        this.$element('gradient1').show()
    },
    opengradient2(){
        this.$element('gradient2').show()
    },
    opengradient3(){
        this.$element('gradient3').show()
    },
    opengradient4(){
        this.$element('gradient4').show()
    },
    openaccess1(){
        this.$element('access1').show()
    },
    openmultiMode1(){
        this.$element('multiMode1').show()
    },
    touchStart(event){

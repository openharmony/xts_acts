...
export default function undo() {  describe('toolbarPropsJsTest5', function () {

    var name = 'toolbarItem', nameA = 'ToolbarItem', labelName = "toolbar-item";
    ...
    */
     ...
     * @tc.desc      ACE
     */
    it('test'+nameA+'ValuePropNone', 0, async function (done) {
        console.info('test'+nameA+'ShowPropNone START');
        console.info("["+name+"Props] get globalThis.value is: " + JSON.stringify(globalThis.value));
    ...
    /**
     * @tc.number    SUB_ACE_BASIC_COMPONENT_JS_API_0100
     * @tc.name      testToolbarItemValuePropNone
     * @tc.desc      ACE
     */
    it('test'+nameA+'ValuePropNone', 0, async function (done) {
        console.info('test'+nameA+'ShowPropNone START');
    ...
    /**
     * @tc.number    SUB_ACE_BASIC_COMPONENT_JS_API_0100
     * @tc.name      testToolbarItemIconProp
     * @tc.desc      ACE
     */
    it('test'+nameA+'ValuePropNone', 0, async function (done) {
        console.info('test'+nameA+'ShowPropNone START');
    ...
    /**
     * @tc.number    SUB_ACE_BASIC_COMPONENT_JS_API_0100
     * @tc.name      testToolbarItemIconPropNone
     * @tc.desc      ACE
     */
    it('test'+nameA+'IconPropNone', 0, async function (done) {
        console.info('test'+nameA+'ShowPropNone START');
        console.info("["+name+"Props] get globalThis.value is: " + JSON.stringify(globalThis.value));

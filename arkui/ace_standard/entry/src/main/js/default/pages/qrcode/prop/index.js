...
export default {
    data:{
        ...
        qrcodeTypeValue : null,
        qrcodeTypeValueNone : null,
        qrcodeTypeRect : null,
    ...
    onShow(){
        ...
        globalThis.value = {
            ...
            qrcodeTypeValue : this.qrcodeTypeValue,
            qrcodeTypeValueNone : this.qrcodeTypeValueNone,
            qrcodeTypeRect : this.qrcodeTypeRect,
            qrcodeTypeCircle : this.qrcodeTypeCircle,
            qrcodeTypeNone : this.qrcodeTypeNone
        }
    },
    ...
    getSpecificPropValues(){
        this.qrcodeTypeValue = this.$element("qrcodeTypeValue").getInspector()
        this.qrcodeTypeValueNone = this.$element("qrcodeTypeValueNone").getInspector()
        this.qrcodeTypeRect = this.$element("qrcodeTypeRect").getInspector()
        this.qrcodeTypeCircle = this.$element("qrcodeTypeCircle").getInspector()
        this.qrcodeTypeNone = this.$element("qrcodeTypeNone").getInspector()
    }
}

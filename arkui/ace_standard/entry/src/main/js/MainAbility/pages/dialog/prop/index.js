...
export default {
    ...
    onShow(){
        ...
        globalThis.value = {
            ...
            dragableNone:this.dragableNone,
            dragableTrue:this.dragableTrue,
            dragableFalse:this.dragableFalse,
        }
    },
    getCommonPropValues(){
    ...
    getSpecificPropValues(){
        this.dragableNone = this.$element("dragableNone").getInspector()
        this.dragableTrue = this.$element("dragableTrue").getInspector()
        this.dragableFalse = this.$element("dragableFalse").getInspector()
    },
}

...
export default {
    ...
    functionTestA1(event){
        var function1 =  this.$element('bar1');
        function1.focus(true)
        var rect = function1.getBoundingClientRect();
        var width = rect.width;
        var height = rect.height;
    ...
    functionTestB1(event){
        var function1 =  this.$element('con1');
        function1.focus(true)
        var rect = function1.getBoundingClientRect();
        var width = rect.width;
        var height = rect.height;
    ...
    functionTestA2(event){
        var function2 =  this.$element('bar2');
        let observer = function2.createIntersectionObserver({
            ratios: [0.2, 0], // number
        });
        observer.observe((isVisible, ratio)=> {
    ...
    functionTestB2(event){
        var function2 =  this.$element('con2');
        let observer = function2.createIntersectionObserver({
            ratios: [0.2, 0], // number
        });
        observer.observe((isVisible, ratio)=> {
    ...
    functionTestA3(event){
        var function3 =  this.$element('bar3');
        var animation = function3.animate(frames, options);
        animation.play()
        animation.onfinish = function(){
            prompt.showToast({
    ...
    functionTestB3(event){
        var function3 =  this.$element('con3');
        var animation = function3.animate(frames, options);
        animation.play()
        animation.onfinish = function(){
            prompt.showToast({

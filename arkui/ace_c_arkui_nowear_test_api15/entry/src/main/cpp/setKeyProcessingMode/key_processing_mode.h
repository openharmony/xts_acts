 ...
 */
 ...
 public:
     ~KeyProcessingMode();
     static napi_value KeyProcessingMode001(napi_env env, napi_callback_info info);
     static napi_value KeyProcessingMode002(napi_env env, napi_callback_info info);
 };
 } // namespace ArkUICapiTest

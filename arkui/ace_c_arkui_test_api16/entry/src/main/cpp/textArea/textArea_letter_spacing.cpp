...
napi_value TextAreaLetterSpacing::textAreaLetterSpacing001(napi_env env, napi_callback_info info)
{
    ...
    ArkUI_NumberValue textarealetterspacing[] = {{.i32 = 1}};
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "Manager",
                    ...
                    nodeAPI->getAttribute(textarea, NODE_TEXT_AREA_LETTER_SPACING)->value[0].i32);
    ASSERT_EQ(nodeAPI->getAttribute(textarea, NODE_TEXT_AREA_LETTER_SPACING)->value[0].u32, 1);

    ArkUI_NumberValue textarealetterspacing2[] = {{.i32 = -1}};

...
static void OnEventReceive(ArkUI_NodeEvent *event)
{
    ...
    // } else {
    //     OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "KeyEventStopPropagation",
    //                  "KeyEventStopPropagation result : %{public}d", type);
    // }
}

napi_value KeyEventStopPropagationTest::KeyEventStopPropagationTest_001(napi_env env, napi_callback_info info)
{
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "KeyEventStopPropagation", "CreateNativeNode");
    ...
    if ((env == nullptr) || (info == nullptr)) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "KeyEventStopPropagation", "GetContext env or info is null");
        return nullptr;
    }
    ...
    // id_item.string = "KeyEventStopPropagation";
    ...
    if (OH_NativeXComponent_AttachNativeRootNode(PluginManager::GetInstance()->GetNativeXComponent(id), column) ==
         INVALID_PARAM) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "KeyEventStopPropagation",

...
namespace ArkUICapiTest {
    ...
    napi_value ButtonAxisEventTest::CreateNativeNode(napi_env env, napi_callback_info info)
    {
        OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "ButtonAxisEventTest", "CreateNativeNode");
        ...
        if ((env == nullptr) || (info == nullptr)) {
            OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN,
                "ButtonAxisEventTest", "GetContext env or info is null");
            return nullptr;
        }
        ...
        == INVALID_PARAM) {
            OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "ButtonAxisEventTest",

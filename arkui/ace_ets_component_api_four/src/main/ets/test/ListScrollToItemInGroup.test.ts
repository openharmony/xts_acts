...
export default function ListScrollToItemInGroup() {
  const SUITE = 'ListScrollToItemInGroup'
  const waitUiReadyMs = 2000;

  describe('ListScrollToItemInGroup', function () {
    ...
    it('ArkUI_List_Scroll_To_Item_In_Group_0001', 0, async function (done) {
        ...
        let ListItem = Utils.getComponentRect('ListItem_Group0_Index0');
    ...
    it('ArkUI_List_Scroll_To_Item_In_Group_0100', 0, async function (done) {
        ...
        let btn = await driver.findComponent(ON.id('Btn_0_1'));
        await btn.click();
    ...
    it('ArkUI_List_Scroll_To_Item_In_Group_0200', 0, async function (done) {
        ...
        let driver = Driver.create();
        let btn = await driver.findComponent(ON.id('Btn_1_2'));
        await btn.click();
        await Utils.sleep(2000);
        let center = Utils.getComponentRect('CenterLine');
    ...
    it('ArkUI_List_Scroll_To_Item_In_Group_0300', 0, async function (done) {
        ...
        let driver = Driver.create();
        let btn = await driver.findComponent(ON.id('Btn_2_2'));
        await btn.click();
        await Utils.sleep(2000);
        let List = Utils.getComponentRect('MyList1');
    ...
    it('ArkUI_List_Scroll_To_Item_In_Group_0400', 0, async function (done) {
        ...
        let driver = Driver.create();
        let btn = await driver.findComponent(ON.id('Btn_3_1'));
        await btn.click();
        await Utils.sleep(2000);
        let List = Utils.getComponentRect('MyList1');
    ...
    it('ArkUI_List_Scroll_To_Item_In_Group_0500', 0, async function (done) {
        ...
        let driver = Driver.create();
        let btn = await driver.findComponent(ON.id('Btn_3_11'));
        await btn.click();
        await Utils.sleep(2000);
        let List = Utils.getComponentRect('MyList1');
    ...
    it('ArkUI_List_Scroll_To_Item_In_Group_0600', 0, async function (done) {
        ...
        let OldListItem = Utils.getComponentRect('ListItem_Group3_Index11');
        let driver = Driver.create();
        let btn = await driver.findComponent(ON.id('Btn_Err_Group'));
        await btn.click();
        await Utils.sleep(2000);
        let ListItem = Utils.getComponentRect('ListItem_Group3_Index11');

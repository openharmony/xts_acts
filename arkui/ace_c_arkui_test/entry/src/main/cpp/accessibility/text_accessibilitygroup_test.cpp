...
static napi_value TestTextAccessibilityGroup001(napi_env env, napi_callback_info info)
{
...
static napi_value TestTextAccessibilityGroup002(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
...
static napi_value TestTextAccessibilityGroup003(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
...
static napi_value TestTextAccessibilityGroup004(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);

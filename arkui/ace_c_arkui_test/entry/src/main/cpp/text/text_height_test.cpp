...
static napi_value TestTextHeight001(napi_env env, napi_callback_info info)
{
...
static napi_value TestTextHeight002(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    float height = -50;
...
static napi_value TestTextHeight003(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    float height = 500;

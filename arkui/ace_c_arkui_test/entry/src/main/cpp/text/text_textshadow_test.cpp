...
static napi_value TestTextTextShadow001(napi_env env, napi_callback_info info)
{
...
static napi_value TestTextTextShadow002(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    float radius = 20;
...
static napi_value TestTextTextShadow003(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    float radius = 1000;

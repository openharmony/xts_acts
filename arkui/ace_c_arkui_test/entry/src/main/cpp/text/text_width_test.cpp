...
static napi_value TestTextWidth001(napi_env env, napi_callback_info info)
{
...
static napi_value TestTextWidth002(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    float width = -100;
...
static napi_value TestTextWidth003(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    float width = 500;

...
#include "textarea_onblur_test.h"
...
static void OnEventReceive(ArkUI_NodeEvent *event)
{
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "TextAreaOnBlurTest", "OnEventReceive eventId: %{public}d",
                 eventId);
...
napi_value TextAreaOnBlurTest::CreateNativeNode(napi_env env, napi_callback_info info)
{
    size_t argc = PARAM_1;
    ...
    nodeAPI->registerNodeEvent(textArea, NODE_ON_BLUR, ON_BLUR_EVENT_ID, nullptr);

...
static napi_value TestTextAreaStopEditing001(napi_env env, napi_callback_info info)
{
...
static napi_value TestTextAreaStopEditing002(napi_env env, napi_callback_info info)
{
    NAPI_START(textArea, ARKUI_NODE_TEXT_AREA);

...
napi_value CustomComponentDrawContextGetSizeTest::CreateNativeNode(napi_env env, napi_callback_info info)
{
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "CustomComponentDrawContextGetSizeTest", "CreateNativeNode");

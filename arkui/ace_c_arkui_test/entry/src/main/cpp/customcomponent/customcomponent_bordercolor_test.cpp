...
static napi_value TestCustomComponentBorderColor001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCustomComponentBorderColor002(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);

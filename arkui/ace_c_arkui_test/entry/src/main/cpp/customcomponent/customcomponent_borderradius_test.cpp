...
static napi_value TestCustomComponentBorderRadius001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCustomComponentBorderRadius002(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static napi_value TestCustomComponentBorderRadius003(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static napi_value TestCustomComponentBorderRadius004(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static napi_value TestCustomComponentBorderRadius005(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static napi_value TestCustomComponentBorderRadius006(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);

...
#define WIDTH 100
#define HEIGHT 100
static napi_value TestCustomComponentMeasuredSize001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCustomComponentMeasuredSize002(napi_env env, napi_callback_info info)
{

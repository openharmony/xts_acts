...
static napi_value TestCustomComponentMask001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCustomComponentMask002(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask003(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask004(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask005(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask006(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask007(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask008(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask009(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask010(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask011(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask012(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask013(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask014(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask015(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static napi_value TestCustomComponentMask016(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
    ...
    if (nodeAPI->getAttribute(custom, NODE_MASK) != nullptr) {
        ASSERT_NE(nodeAPI->getAttribute(custom, NODE_MASK)->value[PARAM_2].f32, maskStrokeWidth);
        ASSERT_NE(nodeAPI->getAttribute(custom, NODE_MASK)->value[PARAM_4].f32, maskProgressCurrentValue);
        ASSERT_NE(nodeAPI->getAttribute(custom, NODE_MASK)->value[PARAM_5].f32, maskProgressMaxValue);
    }
    NAPI_END;
}
} // namespace ArkUICapiTest

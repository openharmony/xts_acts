...
static napi_value TestCustomComponentScale001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCustomComponentScale002(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float scaleX = PARAM_0_POINT_5;
...
static napi_value TestCustomComponentScale003(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static napi_value TestCustomComponentScale004(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float scaleX = PARAM_2;
    float scaleY = PARAM_1;
...
static napi_value TestCustomComponentScale005(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);

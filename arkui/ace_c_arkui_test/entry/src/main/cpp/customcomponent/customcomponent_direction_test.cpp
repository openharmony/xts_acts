...
static napi_value TestCustomComponentDirection001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCustomComponentDirection002(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static napi_value TestCustomComponentDirection003(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static napi_value TestCustomComponentDirection004(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    int32_t direction = ARKUI_DIRECTION_AUTO;
    ASSERT_EQ(nodeAPI->getAttribute(custom, NODE_DIRECTION)->value[PARAM_0].u32, direction);
...
static napi_value TestCustomComponentDirection005(napi_env env, napi_callback_info info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);

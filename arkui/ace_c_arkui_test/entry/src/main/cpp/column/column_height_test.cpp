...
static napi_value TestColumnHeight001(napi_env env, napi_callback_info info)
{
...
static napi_value TestColumnHeight002(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float height = -50;
...
static napi_value TestColumnHeight003(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float height = 500;

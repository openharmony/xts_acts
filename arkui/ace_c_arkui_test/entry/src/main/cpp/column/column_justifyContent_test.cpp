...
static napi_value TestColumnJustifyContent001(napi_env env, napi_callback_info info)
{
...
static napi_value TestColumnJustifyContent002(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static napi_value TestColumnJustifyContent003(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static napi_value TestColumnJustifyContent004(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static napi_value TestColumnJustifyContent005(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static napi_value TestColumnJustifyContent006(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static napi_value TestColumnJustifyContent007(napi_env env, napi_callback_info info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);

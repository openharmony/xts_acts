...
static napi_value TestDatePickerSelectedTextStyle001(napi_env env, napi_callback_info info)
{
...
static napi_value TestDatePickerSelectedTextStyle002(napi_env env, napi_callback_info info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};

...
static napi_value TestStackBackgroundImagePosition001(napi_env env, napi_callback_info info)
{
    ...
    auto ret = nodeAPI->setAttribute(stack, NODE_BACKGROUND_IMAGE_POSITION, &value_item);
...
static napi_value TestStackBackgroundImagePosition002(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
    float positionX = -10;
    float positionY = -5;

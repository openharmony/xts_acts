...
static napi_value TestStackPosition001(napi_env env, napi_callback_info info)
{
...
static napi_value TestStackPosition002(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
    float positionX = -10;
    float positionY = -10;

...
static napi_value TestRefreshPullToRefresh001(napi_env env, napi_callback_info info)
{
...
static napi_value TestRefreshPullToRefresh003(napi_env env, napi_callback_info info)
{
    NAPI_START(refresh, ARKUI_NODE_REFRESH);

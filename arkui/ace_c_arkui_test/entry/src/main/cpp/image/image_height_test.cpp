...
static napi_value TestImageHeight001(napi_env env, napi_callback_info info)
{
...
static napi_value TestImageHeight002(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float height = -50;
...
static napi_value TestImageHeight003(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float height = 500;

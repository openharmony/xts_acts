...
static napi_value TestImageAutoResize001(napi_env env, napi_callback_info info)
{
...
static napi_value TestImageAutoResize002(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);

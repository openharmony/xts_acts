...
static napi_value TestImageWidth001(napi_env env, napi_callback_info info)
{
...
static napi_value TestImageWidth002(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float width = -100;
...
static napi_value TestImageWidth003(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float width = 500;

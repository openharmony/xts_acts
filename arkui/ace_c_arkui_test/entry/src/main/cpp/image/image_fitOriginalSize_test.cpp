...
static napi_value TestImageFitOriginalSize001(napi_env env, napi_callback_info info)
{
...
static napi_value TestImageFitOriginalSize002(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static napi_value TestImageFitOriginalSize003(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static napi_value TestImageFitOriginalSize004(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static napi_value TestImageFitOriginalSize005(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);

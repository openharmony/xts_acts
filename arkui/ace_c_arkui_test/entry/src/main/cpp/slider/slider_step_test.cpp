...
static napi_value TestSliderStep001(napi_env env, napi_callback_info info)
{
...
static napi_value TestSliderStep002(napi_env env, napi_callback_info info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static napi_value TestSliderStep003(napi_env env, napi_callback_info info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static napi_value TestSliderStep004(napi_env env, napi_callback_info info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static napi_value TestSliderStep005(napi_env env, napi_callback_info info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);

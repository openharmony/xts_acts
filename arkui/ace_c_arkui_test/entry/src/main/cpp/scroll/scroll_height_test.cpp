...
static napi_value TestScrollHeight001(napi_env env, napi_callback_info info)
{
...
static napi_value TestScrollHeight002(napi_env env, napi_callback_info info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float height = -100;
    ArkUI_NumberValue height_value[] = {{.f32 = height}};
...
static napi_value TestScrollHeight003(napi_env env, napi_callback_info info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float height = 10000;
    ArkUI_NumberValue height_value[] = {{.f32 = height}};

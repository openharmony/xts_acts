...
static napi_value TestScrollFriction001(napi_env env, napi_callback_info info)
{
...
static napi_value TestScrollFriction002(napi_env env, napi_callback_info info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float friction = 0.9;
    ArkUI_NumberValue value[] = {{.f32 = friction}};

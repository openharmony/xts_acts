...
static napi_value TestScrollScale001(napi_env env, napi_callback_info info)
{
...
static napi_value TestScrollScale002(napi_env env, napi_callback_info info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
...
static napi_value TestScrollScale003(napi_env env, napi_callback_info info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);

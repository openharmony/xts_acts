...
static napi_value TestTextPickerSelectedTextStyle001(napi_env env, napi_callback_info info)
{
...
static napi_value TestTextPickerSelectedTextStyle002(napi_env env, napi_callback_info info)
{
    NAPI_START(textPicker, ARKUI_NODE_TEXT_PICKER);
    ArkUI_AttributeItem value_item = {};

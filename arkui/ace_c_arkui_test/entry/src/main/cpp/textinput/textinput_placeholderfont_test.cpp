...
static napi_value TestTextInputPlaceHolderFont001(napi_env env, napi_callback_info info)
{
    ...
    auto ret = nodeAPI->setAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT, &value_item);
    ASSERT_EQ(ret, SUCCESS);
    ASSERT_EQ(nodeAPI->getAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT)->value[PARAM_0].f32, FONT_SIZE);
    ASSERT_EQ(nodeAPI->getAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT)->value[PARAM_1].i32,
              ARKUI_FONT_STYLE_NORMAL);
    ASSERT_EQ(nodeAPI->getAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT)->value[PARAM_2].i32,
...
static napi_value TestTextInputPlaceHolderFont002(napi_env env, napi_callback_info info)
{
    ...
    auto ret = nodeAPI->setAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT, &value_item);
    ASSERT_EQ(ret, SUCCESS);
    ASSERT_EQ(nodeAPI->getAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT)->value[PARAM_0].f32, PARAM_0);
    ASSERT_EQ(nodeAPI->getAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT)->value[PARAM_1].i32,
              ARKUI_FONT_STYLE_NORMAL);
    ASSERT_EQ(nodeAPI->getAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT)->value[PARAM_2].i32,
              ARKUI_FONT_WEIGHT_NORMAL);
...
static napi_value TestTextInputPlaceHolderFont005(napi_env env, napi_callback_info info)
{
    ...
    auto ret = nodeAPI->setAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT, &value_item);
    ASSERT_EQ(ret, SUCCESS);
    ASSERT_EQ(nodeAPI->getAttribute(textInput, NODE_TEXT_AREA_PLACEHOLDER_FONT)->value[PARAM_0].f32, DEFAULT_SIZE);
    NAPI_END;
}

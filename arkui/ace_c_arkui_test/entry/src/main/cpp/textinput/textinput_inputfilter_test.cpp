...
static napi_value TestTextInputInputFilter001(napi_env env, napi_callback_info info)
{
...
static napi_value TestTextInputInputFilter002(napi_env env, napi_callback_info info)
{
    NAPI_START(textinput, ARKUI_NODE_TEXT_INPUT);
    ArkUI_AttributeItem valueItem = {};

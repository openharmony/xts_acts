...
static napi_value TestCommonAttrsFlexBasis001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCommonAttrsFlexBasis002(napi_env env, napi_callback_info info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
    float width = -100.0;
    ArkUI_NumberValue value[] = {{.f32 = width}};

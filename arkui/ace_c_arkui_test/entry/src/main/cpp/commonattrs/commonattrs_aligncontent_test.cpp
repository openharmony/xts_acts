...
static napi_value TestCommonAttrsAlignContent001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCommonAttrsAlignContent002(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static napi_value TestCommonAttrsAlignContent003(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static napi_value TestCommonAttrsAlignContent004(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static napi_value TestCommonAttrsAlignContent005(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static napi_value TestCommonAttrsAlignContent006(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static napi_value TestCommonAttrsAlignContent007(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static napi_value TestCommonAttrsAlignContent008(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static napi_value TestCommonAttrsAlignContent009(napi_env env, napi_callback_info info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);

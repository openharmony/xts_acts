...
#ifndef ARKUI_CAPI_XTS_WATERFLOW_SCROLL_BY_TEST_H
#define ARKUI_CAPI_XTS_WATERFLOW_SCROLL_BY_TEST_H
...
constexpr int32_t BY_ITEM_COUNT_5 = PARAM_5;

class WaterFlowScrollByTest {
public:
    ~WaterFlowScrollByTest() = default;
    static napi_value TestWaterFlowScrollBy001(napi_env env, napi_callback_info info);
    static napi_value TestWaterFlowScrollBy002(napi_env env, napi_callback_info info);
    static napi_value TestWaterFlowScrollBy003(napi_env env, napi_callback_info info);
    static napi_value TestWaterFlowScrollBy004(napi_env env, napi_callback_info info);
    static napi_value WaterFlowGetScrollByData(napi_env env, napi_callback_info info);
    ...
    template<int32_t size = BY_ITEM_COUNT_5, typename... Args>
...
#endif // ARKUI_CAPI_XTS_WATERFLOW_SCROLL_BY_TEST_H
...
static napi_value TestListEnableScrollInteraction001(napi_env env, napi_callback_info info)
{
...
static napi_value TestListEnableScrollInteraction002(napi_env env, napi_callback_info info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static napi_value TestListEnableScrollInteraction003(napi_env env, napi_callback_info info)
{
    NAPI_START(list, ARKUI_NODE_LIST);

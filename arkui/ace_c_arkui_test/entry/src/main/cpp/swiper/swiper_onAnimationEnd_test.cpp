 ...
 */
#include "swiper_onAnimationEnd_test.h"
...
napi_value SwiperOnAnimationEndTest::CreateNativeNode(napi_env env, napi_callback_info info)
{
    OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "SwiperOnAnimationEndTest", "CreateNativeNode");
    ...
    auto text_end = std::make_shared<TextComponent>();
    text_end->SetTextContent("test end");
    ...
    if (OH_NativeXComponent_AttachNativeRootNode(PluginManager::GetInstance()->GetNativeXComponent(id), column) ==
        INVALID_PARAM) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "SwiperOnAnimationEndTest",

...
static napi_value TestSwiperHeight001(napi_env env, napi_callback_info info)
{
...
static napi_value TestSwiperHeight002(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    float height = -100;
...
static napi_value TestSwiperHeight003(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    float height = 10000;

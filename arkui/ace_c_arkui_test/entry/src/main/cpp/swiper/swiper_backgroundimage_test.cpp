...
static napi_value TestSwiperBackgroundImage001(napi_env env, napi_callback_info info)
{
...
static napi_value TestSwiperBackgroundImage002(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    const char *imageUrl = "./resources/base/media/icon.png";
...
static napi_value TestSwiperBackgroundImage003(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    const char *imageUrl = "./resources/base/media/icon.png";
...
static napi_value TestSwiperBackgroundImage004(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    const char *imageUrl = "./resources/base/media/icon.png";
...
static napi_value TestSwiperBackgroundImage005(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
...
static napi_value TestSwiperBackgroundImage006(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    int32_t repeatValue = -1;
...
static napi_value TestSwiperBackgroundImage007(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);

...
static napi_value TestSwiperItemSpace001(napi_env env, napi_callback_info info)
{
...
static napi_value TestSwiperItemSpace002(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
...
static napi_value TestSwiperItemSpace003(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    float itemSpace = -20;

...
static napi_value TestSwiperAutoPlay001(napi_env env, napi_callback_info info)
{
...
static napi_value TestSwiperAutoPlay002(napi_env env, napi_callback_info info)
{
    NAPI_START(swiper, ARKUI_NODE_SWIPER);
    int32_t autoPlay = 1;
    ArkUI_NumberValue value[] = {{.i32 = autoPlay}};

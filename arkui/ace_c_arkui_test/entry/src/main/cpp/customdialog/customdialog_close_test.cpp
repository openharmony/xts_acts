...
static napi_value TestCustomDialogClose001(napi_env env, napi_callback_info info)
{
...
static napi_value TestCustomDialogClose002(napi_env env, napi_callback_info)
{
    const auto dialogAPI = reinterpret_cast<ArkUI_NativeDialogAPI_1 *>(
        OH_ArkUI_QueryModuleInterfaceByName(ARKUI_NATIVE_DIALOG, "ArkUI_NativeDialogAPI_1"));

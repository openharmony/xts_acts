...
static napi_value TestToggleWidth001(napi_env env, napi_callback_info info)
{
...
static napi_value TestToggleWidth002(napi_env env, napi_callback_info info)
{
    NAPI_START(toggle, ARKUI_NODE_TOGGLE);
    float width = 10000;
    ArkUI_NumberValue value[] = {{.f32 = width}};
...
static napi_value TestToggleWidth003(napi_env env, napi_callback_info info)
{
    NAPI_START(toggle, ARKUI_NODE_TOGGLE);
    float width = -10;
    ArkUI_NumberValue value[] = {{.f32 = width}};

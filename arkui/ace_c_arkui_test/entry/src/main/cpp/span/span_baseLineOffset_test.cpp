...
static napi_value TestSpanBaseLineOffset001(napi_env env, napi_callback_info info)
{
...
static napi_value TestSpanBaseLineOffset002(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_SPAN);
...
static napi_value TestSpanBaseLineOffset003(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_SPAN);
...
static napi_value TestSpanBaseLineOffset004(napi_env env, napi_callback_info info)
{
    NAPI_START(text, ARKUI_NODE_SPAN);

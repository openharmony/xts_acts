...
static napi_value TestListItemLinearGradient001(napi_env env, napi_callback_info info)
{
    ...
    ASSERT_EQ(nodeAPI->getAttribute(listItem, NODE_LINEAR_GRADIENT)->value[PARAM_0].f32, PARAM_0);
...
static napi_value TestListItemLinearGradient002(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_90;
...
static napi_value TestListItemLinearGradient003(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_180;
...
static napi_value TestListItemLinearGradient004(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_90;
...
static napi_value TestListItemLinearGradient005(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_180;
...
static napi_value TestListItemLinearGradient006(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_180;
...
static napi_value TestListItemLinearGradient007(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_180;
...
static napi_value TestListItemLinearGradient008(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_180;
...
static napi_value TestListItemLinearGradient009(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_180;
...
static napi_value TestListItemLinearGradient010(napi_env env, napi_callback_info info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float angle = SIZE_180;

...
export const oHGetSdkMinorApiVersion: () => number;
export const oHGetSdkPatchApiVersion: () => number;
...
export const oHIsApiVersionGreaterOrEqual: (majorApiVersion: Number, minorApiVersion: Number, patchApiVersion: Number) => number;
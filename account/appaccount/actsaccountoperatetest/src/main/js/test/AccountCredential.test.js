    ...
    describe('ActsAppAccountCredential', function () {
        ...
        */
        it('ActsAppAccountCredential_0100', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0100 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_0100", (err)=>{
                console.debug("====>add account ActsAppAccountCredential_0100 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("account_name_0100", "credentialType1", "credential1",(err)=>{
                    console.debug("====>ActsAppAccountCredential_0100 setCredential:" + JSON.stringify(err));
                    expect(err).assertEqual(null);
                    appAccountManager.getCredential("account_name_0100", "credentialType1", (err,data)=>{
                        console.debug("====>getCredential 0100 err:" + JSON.stringify(err));
                        console.debug("====>getCredential 0100 data:" + JSON.stringify(data));
                        expect(err).assertEqual(null);
                        ...
                        appAccountManager.removeAccount("account_name_0100", (err)=>{
                            ...
                            expect(err).assertEqual(null);
                            console.debug("====>ActsAppAccountCredential_0100 end====");
                            done();
                        });
                    });
                });
        ...
        */
        it('ActsAppAccountCredential_0200', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0200 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add accountActsAppAccountCredential_0200 start====");
            await appAccountManager.createAccount("account_name_0200");
            console.debug("====>setCredential ActsAppAccountCredential_0200 start====");
            try{
            ...
            console.debug("====>getCredential ActsAppAccountCredential_0200 start====");
            try{
            ...
            console.debug("====>getCredential ActsAppAccountCredential_0200 data:" + JSON.stringify(data));
            expect(data).assertEqual("credential2");
            console.debug("====>delete account ActsAppAccountCredential_0200 start====");
            appAccountManager.removeAccount("account_name_0200")
            console.debug("====>ActsAppAccountCredential_0200 end====");
            done();
        });
        ...
        */
        it('ActsAppAccountCredential_0300', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0300 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_0300",(err)=>{
                console.debug("====>add account ActsAppAccountCredential_0300 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("account_name_0300", "credentialType3", "credential3",(err)=>{
                    console.debug("====>setCredential first time 0300 err:" + JSON.stringify(err));
                    expect(err).assertEqual(null);
                    appAccountManager.setCredential("account_name_0300", "credentialType3", "newcredential3",(err)=>{
                        console.debug("====>setCredential second time 0300 err:" + JSON.stringify(err));
                        expect(err).assertEqual(null);
                        appAccountManager.getCredential("account_name_0300", "credentialType3", (err, data)=>{
                            console.debug("====>getCredential 0300 err:" + JSON.stringify(err));
                            console.debug("====>getCredential 0300 data:" + JSON.stringify(data));
                            expect(err).assertEqual(null);
                            ...
                            appAccountManager.removeAccount("account_name_0300", (err)=>{
                                ...
                                expect(err).assertEqual(null);
                                console.debug("====>ActsAppAccountCredential_0300 end====");
                                done();
                            });
                        });
                    });
        ...
        */
        it('ActsAppAccountCredential_0400', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0400 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_0400 start====");
            ...
            console.debug("====>ActsAppAccountCredential_0400 getCredential data:" + JSON.stringify(data));
            expect(data).assertEqual("newcredential4");
            console.debug("====>delete account ActsAppAccountCredential_0400 start====");
            appAccountManager.removeAccount("account_name_0400")
            console.debug("====>ActsAppAccountCredential_0400 end====");
            done();
        });
        ...
        */
        it('ActsAppAccountCredential_0500', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0500 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_0500",(err)=>{
                console.debug("====>add account ActsAppAccountCredential_0500 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("account_name_0500", "credentialType5", "", (err)=>{
                    console.debug("====>setCredential ActsAppAccountCredential_0500 err:" + JSON.stringify(err));
                    expect(err).assertEqual(null);
                    appAccountManager.getCredential("account_name_0500", "credentialType5", (err,data)=>{
                        console.debug("====>getCredential ActsAppAccountCredential_0500 err:" + JSON.stringify(err));
                        console.debug("====>getCredential ActsAppAccountCredential_0500 data:" + JSON.stringify(data));
                        expect(err).assertEqual(null);
                        expect(data).assertEqual("");
                        appAccountManager.removeAccount("account_name_0500", (err)=>{
                            console.debug("====>delete Account ActsAppAccountCredential_0500 err:" + JSON.stringify(err));
                            expect(err).assertEqual(null);
                            console.debug("====>ActsAppAccountCredential_0500 end====");
                            done();
                        });
                    });
                });
        ...
        */
        it('ActsAppAccountCredential_0600', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0600 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_0600 start====");
            await appAccountManager.createAccount("account_name_0600");
            console.debug("====>setCredential ActsAppAccountCredential_0600 start====");
            await appAccountManager.setCredential("account_name_0600", "credentialType6", "");
            console.debug("====>getCredential ActsAppAccountCredential_0600 start====");
            var data = await appAccountManager.getCredential("account_name_0600", "credentialType6");
            console.debug("====>getCredential ActsAppAccountCredential_0600 data" + JSON.stringify(data));
            expect(data).assertEqual("");
            console.debug("====>delete account ActsAppAccountCredential_0600 start====");
            await appAccountManager.removeAccount("account_name_0600");
            console.debug("====>ActsAppAccountCredential_0600 end====");
            done();
        });
        ...
        */
        it('ActsAppAccountCredential_0700', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0700 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_0700", (err)=>{
                console.debug("====>add account ActsAppAccountCredential_0700 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("account_name_0700", "", "credential7", (err)=>{
                    console.debug("====>setCredential ActsAppAccountCredential_0700 err:" + JSON.stringify(err));
                    expect(err.code == 12300002).assertEqual(true);
                    appAccountManager.removeAccount("account_name_0700", (err)=>{
                        console.debug("====>delete Account ActsAppAccountCredential_0700 err:" + JSON.stringify(err));
                        expect(err).assertEqual(null);
                        console.debug("====>ActsAppAccountCredential_0700 end====");
                        done();
                    });
                });
            });
        ...
        */
        it('ActsAppAccountCredential_0800', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0800 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ccountActsAppAccountCredential_0800 start====");
            ...
            try{
                ...
                console.debug("====>setCredential ActsAppAccountCredential_0800 err:" + JSON.stringify(err));
                expect(err.code == 12300002).assertEqual(true);
                console.debug("====>delete account ActsAppAccountCredential_0800 start====");
                appAccountManager.removeAccount("account_name_0800");
                console.debug("====>ActsAppAccountCredential_0800 end====");
                done();
            }
        });
        ...
        */
        it('ActsAppAccountCredential_0900', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_0900 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_0900", (err)=>{
                console.debug("====>add account ActsAppAccountCredential_0900 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.getCredential("account_name_0900", "", (err)=>{
                    console.debug("====>getCredential ActsAppAccountCredential_0900 err:" + JSON.stringify(err));
                    expect(err.code == 12300002).assertEqual(true);
                    appAccountManager.removeAccount("account_name_0900", (err)=>{
                        console.debug("====>delete Account ActsAppAccountCredential_0900 err:" + JSON.stringify(err));
                        expect(err).assertEqual(null);
                        console.debug("====>ActsAppAccountCredential_0900 end====");
                        done();
                    });
                });
            });
        ...
        */
        it('ActsAppAccountCredential_1000', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1000 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_1000 start====");
            await appAccountManager.createAccount("account_name_1000");
            try{
                await appAccountManager.getCredential("account_name_1000","");
            }
            catch(err){
                console.debug("====>getCredential ActsAppAccountCredential_1000 err:" + JSON.stringify(err));
                expect(err.code == 12300002).assertEqual(true);
                console.debug("====>delete account ActsAppAccountCredential_1000 start====");
                await appAccountManager.removeAccount("account_name_1000");
                console.debug("====>ActsAppAccountCredential_1000 end====");
                done();
            }
        });
        ...
        */
        it('ActsAppAccountCredential_1100', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1100 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_1100",(err)=>{
                console.debug("====>add account ActsAppAccountCredential_1100 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("account_name_1100", " ", "credential11",(err)=>{
                    console.debug("====>setCredential ActsAppAccountCredential_1100 err:" + JSON.stringify(err));
                    expect(err).assertEqual(null);
                    appAccountManager.getCredential("account_name_1100", " ", (err, data)=>{
                        console.debug("====>getCredential 1100 err:" + JSON.stringify(err));
                        console.debug("====>getCredential 1100 data:" + JSON.stringify(data));
                        expect(err).assertEqual(null);
                        ...
                        appAccountManager.removeAccount("account_name_1100", (err)=>{
                            ...
                            expect(err).assertEqual(null);
                            console.debug("====>ActsAppAccountCredential_1100 end====");
                            done();
                        });
                    });
                });
        ...
        */
        it('ActsAppAccountCredential_1200', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1200 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_1200 start====");
            await appAccountManager.createAccount("account_name_1200");
            console.debug("====>setCredential ActsAppAccountCredential_1200 start====");
            await appAccountManager.setCredential("account_name_1200", " ", "credential12");
            console.debug("====>getCredential ActsAppAccountCredential_1200 start====");
            var data = await appAccountManager.getCredential("account_name_1200", " ");
            console.debug("====>getCredential ActsAppAccountCredential_1200 data" + JSON.stringify(data));
            expect(data).assertEqual("credential12");
            console.debug("====>delete account ActsAppAccountCredential_1200 start====");
            await appAccountManager.removeAccount("account_name_1200");
            console.debug("====>ActsAppAccountCredential_1200 end====");
            done(); 
        });
        ...
        */
        it('ActsAppAccountCredential_1300', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1300 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_1300",(err)=>{
                console.debug("====>add account ActsAppAccountCredential_1300 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("", "credentialType13", "credential13", (err)=>{
                    console.debug("====>setCredential ActsAppAccountCredential_1300 err:" + JSON.stringify(err));
                    expect(err.code == 12300002).assertEqual(true);
                    appAccountManager.removeAccount("account_name_1300", (err)=>{
                        console.debug("====>delete Account ActsAppAccountCredential_1300 err:" + JSON.stringify(err));
                        expect(err).assertEqual(null);
                        console.debug("====>ActsAppAccountCredential_1300 end====");
                        done();
                    });
                });
            });
        ...
        */
        it('ActsAppAccountCredential_1400', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1400 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_1400 start====");
            ...
            try{
                ...
                console.debug("====>setCredential ActsAppAccountCredential_1400 err:" + JSON.stringify(err));
                expect(err.code == 12300002).assertEqual(true);
                console.debug("====>delete account ActsAppAccountCredential_1400 start====");
                await appAccountManager.removeAccount("account_name_1400");
                console.debug("====>ActsAppAccountCredential_1400 end====");
                done();
            }
        });
        ...
        */
        it('ActsAppAccountCredential_1500', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1500 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            appAccountManager.createAccount("account_name_1500", (err)=>{
                console.debug("====>add account ActsAppAccountCredential_1500 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.getCredential("account_name_1500", "credentialType15", (err)=>{
                    ...
                    appAccountManager.removeAccount("account_name_1500", (err)=>{
                        ...
                        expect(err).assertEqual(null);
                        console.debug("====>ActsAppAccountCredential_1500 end====");
                        done();
                    });
                });
            });
        ...
        */
        it('ActsAppAccountCredential_1600', 0, async function (done) {
            console.debug("cActsAppAccountCredential_1600 start====");
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_1600 start====");
        ...
        */
        it('ActsAppAccountCredential_1700', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1700 start====");
            ...
            appAccountManager.createAccount("account_name_1700", (err)=>{
                console.debug("====>add account ActsAppAccountCredential_1700 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("account_name_1700", "credentialType17", CREDENTIALOVERSIZE, (err)=>{
                    ...
                    console.debug("====>setCredential ActsAppAccountCredential_1700 err:" + JSON.stringify(err));
                    expect(err.code == 12300002).assertEqual(true);
                    appAccountManager.removeAccount("account_name_1700", (err)=>{
                        console.debug("====>delete Account ActsAppAccountCredential_1700 err:" + JSON.stringify(err));
                        expect(err).assertEqual(null);
        ...
        */
        it('ActsAppAccountCredential_1800', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1800 start====");
            var bigStr = "K"
            for(var i = 0;i < 256;i++)
            bigStr = bigStr + "K!@#";
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_1800 start====");
            ...
            try{
                ...
                console.debug("====>setCredential ActsAppAccountCredential_1800 err:" + JSON.stringify(err));
                expect(err.code == 12300002).assertEqual(true);
                console.debug("====>delete account ActsAppAccountCredential_1800 start====");
                await appAccountManager.removeAccount("account_name_1800");
                console.debug("====>ActsAppAccountCredential_1800 end====");
                done();
            }
        });
        ...
        */
        it('ActsAppAccountCredential_1900', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_1900 start====");
            ...
            appAccountManager.createAccount("account_name_1900", (err)=>{
                console.debug("====>add account ActsAppAccountCredential_1900 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential("account_name_1900", CREDENTIALTYPEOVERSIZE, "credential19", (err)=>{
                    ...
                    console.debug("====>setCredential ActsAppAccountCredential_1900 err:" + JSON.stringify(err));
                    expect(err.code == 12300002).assertEqual(true);
                    appAccountManager.removeAccount("account_name_1900", (err)=>{
                        console.debug("====>delete Account ActsAppAccountCredential_1900 err:" + JSON.stringify(err));
                        expect(err).assertEqual(null);
                        console.debug("====>ActsAppAccountCredential_1900 end====");
                        done();
                    });
                });
            });
        ...
        */
        it('ActsAppAccountCredential_2000', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_2000 start====");
            var CREDENTIALTYPEOVERSIZE = "K"
            for(var i = 0;i < 256;i++)
            CREDENTIALTYPEOVERSIZE=CREDENTIALTYPEOVERSIZE+"K!@#";
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_2000 start====");
            ...
            try{
                ...
                console.debug("====>CREDENTIALTYPEOVERSIZE.length:" + JSON.stringify(CREDENTIALTYPEOVERSIZE.length));
                expect(CREDENTIALTYPEOVERSIZE.length).assertEqual(1025);
                console.debug("====>setCredential ActsAppAccountCredential_2000 err:" + JSON.stringify(err));
                expect(err.code == 12300002).assertEqual(true);
                console.debug("====>delete account ActsAppAccountCredential_2000 start====");
                await appAccountManager.removeAccount("account_name_2000");
                console.debug("====>ActsAppAccountCredential_2000 end====");
                done();
            }
        });
        ...
        */
        it('ActsAppAccountCredential_2100', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_2100 start====");
            var NAMEOVERSIZE = "n"
            for(var i = 0;i < 256;i++)
            ...
            appAccountManager.createAccount("account_name_2100", (err)=>{
                console.debug("====>add account ActsAppAccountCredential_2100 err:" + JSON.stringify(err));
                expect(err).assertEqual(null);
                appAccountManager.setCredential(NAMEOVERSIZE, "credentialType21", "credential21", (err)=>{
                    console.debug("====>setCredential ActsAppAccountCredential_2100 err:" + JSON.stringify(err));
                    expect(err.code == 12300002).assertEqual(true);
                    appAccountManager.removeAccount("account_name_2100", (err)=>{
                        console.debug("====>delete Account ActsAppAccountCredential_2100 err:" + JSON.stringify(err));
                        console.debug("====>ActsAppAccountCredential_2100 end====");
                        expect(err).assertEqual(null);
                        done();
                    });
                });
        ...
        */
        it('ActsAppAccountCredential_2200', 0, async function (done) {
            console.debug("====>ActsAppAccountCredential_2200 start====");
            var NAMEOVERSIZE ="n"
            for(var i=0;i<256;i++)
            NAMEOVERSIZE=NAMEOVERSIZE+"name";
            var appAccountManager = account.createAppAccountManager();
            console.debug("====>creat finish====");
            console.debug("====>add account ActsAppAccountCredential_2200 start====");
            try{
                await appAccountManager.createAccount("account_name_2200");
            }
            catch(err){
                console.debug("====>add account ActsAppAccountCredential_2200 err:" + JSON.stringify(err));
                expect().assertFail();
                done();
            }
            console.debug("====>setCredential ActsAppAccountCredential_2200 start====");
            try{
                await appAccountManager.setCredential(NAMEOVERSIZE, "credentialType22", "credential22");
            }
            catch(err){
                console.debug("====>setCredential ActsAppAccountCredential_2200 err:" + JSON.stringify(err));
                expect(err.code == 12300002).assertEqual(true);
                console.debug("====>delete account ActsAppAccountCredential_2200 start====");
                await appAccountManager.removeAccount("account_name_2200");
                console.debug("====>ActsAppAccountCredential_2200 end====");
                done();
            }
        });
    })
